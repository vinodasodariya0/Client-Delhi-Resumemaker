...
public class CropOverlayView extends View {
    ...
    private void drawGuidelines(Canvas canvas) {
        if (this.mGuidelinePaint != null) {
            ...
            canvas.drawLine(f7, rect.top, f7, rect.bottom, this.mGuidelinePaint);
            canvas.drawLine(f8, rect.top, f8, rect.bottom, this.mGuidelinePaint);
            float f9 = rect.top + height;
            float f10 = rect.bottom - height;
            canvas.drawLine(rect.left, f9, rect.right, f9, this.mGuidelinePaint);
    ...
    private void drawCorners(Canvas canvas) {
        if (this.mBorderCornerPaint != null) {
            ...
            float f5 = f2 + f4;
            canvas.drawLine(rect.left - f4, rect.top - f5, rect.left - f4, rect.top + this.mBorderCornerLength, this.mBorderCornerPaint);
            canvas.drawLine(rect.left - f5, rect.top - f4, rect.left + this.mBorderCornerLength, rect.top - f4, this.mBorderCornerPaint);
            canvas.drawLine(rect.right + f4, rect.top - f5, rect.right + f4, rect.top + this.mBorderCornerLength, this.mBorderCornerPaint);
            canvas.drawLine(rect.right + f5, rect.top - f4, rect.right - this.mBorderCornerLength, rect.top - f4, this.mBorderCornerPaint);
            canvas.drawLine(rect.left - f4, rect.bottom + f5, rect.left - f4, rect.bottom - this.mBorderCornerLength, this.mBorderCornerPaint);
            canvas.drawLine(rect.left - f5, rect.bottom + f4, rect.left + this.mBorderCornerLength, rect.bottom + f4, this.mBorderCornerPaint);
            canvas.drawLine(rect.right + f4, rect.bottom + f5, rect.right + f4, rect.bottom - this.mBorderCornerLength, this.mBorderCornerPaint);
            canvas.drawLine(rect.right + f5, rect.bottom + f4, rect.right - this.mBorderCornerLength, rect.bottom + f4, this.mBorderCornerPaint);
        }
    }
