...
public class Format_11 extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        ((AppCompatTextView) findViewById(R.id.title_name)).setText("Perfect Resume");
        ...
        this.mWebView.setOnLongClickListener(new View.OnLongClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_11.AnonymousClass1 */
        ...
        this.save.setOnClickListener(new View.OnClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_11.AnonymousClass2 */

            public void onClick(View view) {
                if (Format_11.this.sp.getInt(Format_11.this, "permissiond") == 1) {
                    try {
                    ...
                    Format_11.this.createPdfFile();
                    Format_11.this.wait_dialog.show();
                    return;
                }
                Format_11.this.PermissionFun();
            }
        });
        this.picker.setOnClickListener(new View.OnClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_11.AnonymousClass3 */

            public void onClick(View view) {
                if (Format_11.this.sp.getInt(Format_11.this, "key") == 0) {
                    Format_11.this.sp.putString(Format_11.this, "type", "text");
                    Format_11.this.openDialog(false);
                } else if (Format_11.this.sp.getInt(Format_11.this, "key") == 1) {
                    Format_11.this.color_dialog.show();
                } else if (Format_11.this.sp.getInt(Format_11.this, "key") == 2) {
                    Format_11.this.color_dialog.show();
                } else if (Format_11.this.sp.getInt(Format_11.this, "key") == 3) {
                    Format_11.this.sp.putString(Format_11.this, "type", "text");
                    Format_11.this.openDialog(false);
                } else if (Format_11.this.sp.getInt(Format_11.this, "key") == 4) {
                    Format_11.this.sp.putString(Format_11.this, "type", "text");
                    Format_11.this.openDialog(false);
                } else if (Format_11.this.sp.getInt(Format_11.this, "key") == 5) {
                    Format_11.this.sp.putString(Format_11.this, "type", "text");
                    Format_11.this.openDialog(false);
                } else if (Format_11.this.sp.getInt(Format_11.this, "key") == 6) {
                    Format_11.this.sp.putString(Format_11.this, "type", "text");
                    Format_11.this.openDialog(false);
                } else if (Format_11.this.sp.getInt(Format_11.this, "key") == 7) {
                    Format_11.this.sp.putString(Format_11.this, "type", "text");
                    Format_11.this.openDialog(false);
                } else if (Format_11.this.sp.getInt(Format_11.this, "key") == 8) {
                    Format_11.this.sp.putString(Format_11.this, "type", "text");
                    Format_11.this.openDialog(false);
                }
            }
        ...
        ((LinearLayout) this.color_dialog.findViewById(R.id.text_lay)).setOnClickListener(new View.OnClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_11.AnonymousClass4 */
        ...
        ((LinearLayout) this.color_dialog.findViewById(R.id.border_lay)).setOnClickListener(new View.OnClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_11.AnonymousClass5 */

            public void onClick(View view) {
                Format_11.this.sp.putString(Format_11.this, "type", "bg");
                Format_11.this.openDialog(false);
            }
        });
    ...
    private void first_load() {
        ...
        if (rawQuery2.getCount() > 0) {
            ...
            if (rawQuery4.getCount() > 0) {
                ...
                this.info = "<div class='w3-padding-12 w3-row w3-brdr-lft w3-margin-bottom'>        <h6 class='t7-block_background w3-padding-tinysmall  w3-upper-case'>" + this.title + "</h6>        <div class='w3-container'>" + this.pro_table + "        </div>    </div>";
            }
            rawQuery4.close();
        ...
        if (rawQuery6.getCount() > 0) {
            ...
            if (!string20.equals("")) {
                this.objective = "<div class='w3-padding-12 w3-row w3-brdr-lft w3-margin-bottom'>        <h6 class='t7-block_background w3-padding-tinysmall  w3-upper-case'>Objective</h6>        <div class='w3-container'>            <p>" + string20 + "</p>        </div>    </div>";
            }
            if (!string21.equals("")) {
                this.declar = "<div class='w3-no-break w3-row w3-brdr-lft w3-margin-bottom'>    <h6 class='t7-block_background w3-padding-tinysmall w3-upper-case'>Declaration</h6>    <div class='w3-container'>        <h6>" + string21 + "</h6>    </div></div>";
            }
        }
        ...
        if (rawQuery7.getCount() > 0) {
            ...
            this.experience = "<div class='w3-no-break w3-row w3-brdr-lft w3-margin-bottom'>         <h6 class='t7-block_background w3-padding-tinysmall  w3-upper-case'>" + str5 + "</h6>         <div class='w3-container'>" + this.sub_exp + "         </div>     </div>";
        } else {
        ...
        if (rawQuery10.getCount() > 0) {
            ...
            this.project = "  <div class='w3-no-break w3-row w3-brdr-lft w3-margin-bottom'>      <h6 class='t7-block_background w3-padding-tinysmall  w3-upper-case'>" + str7 + "</h6>      <div class='w3-container'>" + this.sub_work + "      </div>  </div>";
        }
        rawQuery10.close();
        ...
        if (rawQuery13.getCount() > 0) {
            ...
            for (int i8 = 0; i8 < rawQuery13.getCount(); i8++) {
                ...
                if (rawQuery15.getCount() > 0) {
                    ...
                    for (int i10 = 0; i10 < rawQuery15.getCount(); i10++) {
                        str12 = str12 + "<p class='w3-margin-top-0 w3-margin-bottom-0'><b>" + rawQuery15.getString(rawQuery15.getColumnIndex("title")) + " : </b>" + rawQuery15.getString(rawQuery15.getColumnIndex("value")) + "</b></p>";
            ...
            this.education = "<div class='w3-no-break w3-row w3-brdr-lft w3-margin-bottom w3-margin-top-0'>        <h6 class='t7-block_background w3-padding-tinysmall  w3-upper-case'>" + str10 + "</h6>        <div class='w3-container'>" + this.sub_edu + "        </div>    </div>";
        }
        rawQuery13.close();
        ...
        if (rawQuery16.getCount() > 0) {
            ...
            this.skill = "<div class='w3-no-break w3-row w3-brdr-lft w3-margin-bottom'>    <h6 class='t7-block_background w3-padding-tinysmall w3-upper-case'>" + str13 + "</h6>    <div class='w3-container'>" + this.sub_skill + "    </div></div>";
        }
        rawQuery16.close();
        ...
        if (rawQuery18.getCount() > 0) {
            ...
            this.strength = "<div class='w3-no-break w3-row w3-brdr-lft w3-margin-bottom'>      <h6 class='t7-block_background w3-padding-tinysmall w3-upper-case'>" + str14 + "</h6>      <div class='w3-container'>" + this.sub_strength + "      </div>  </div>";
        }
        rawQuery18.close();
        ...
        if (rawQuery20.getCount() > 0) {
            ...
            this.intrest = " <div class='w3-no-break w3-row w3-brdr-lft w3-margin-bottom'>     <h6 class='t7-block_background w3-padding-tinysmall w3-upper-case'>" + str15 + "</h6>     <div class='w3-container'>" + this.sub_intrest + "     </div> </div>";
        }
        rawQuery20.close();
        ...
        if (rawQuery24.getCount() > 0 || rawQuery22.getCount() > 0) {
            this.explore = " <div class='w3-no-break w3-row w3-brdr-lft w3-margin-bottom'>     <h6 class='t7-block_background w3-padding-tinysmall w3-upper-case'>Industrial Exposure</h6>     <div class='w3-container'>" + this.indrust + this.inplant + "     </div> </div>";
        }
        rawQuery24.close();
        rawQuery22.close();
        ...
        if (rawQuery26.getCount() > 0) {
            ...
            this.achive = " <div class='w3-no-break w3-row w3-brdr-lft w3-margin-bottom'>     <h6 class='t7-block_background w3-padding-tinysmall w3-upper-case'>" + str18 + "</h6>     <div class='w3-container'>" + this.sub_achive + "     </div> </div>";
        }
        rawQuery26.close();
        ...
        if (rawQuery30.getCount() > 0 || rawQuery28.getCount() > 0) {
            this.curricular = "<div class='w3-no-break w3-row w3-brdr-lft w3-margin-bottom'>         <h6 class='t7-block_background w3-padding-tinysmall w3-upper-case'>Curricular Activities</h6>         <div class='w3-container'>" + this.cocuri + this.extra + "         </div>     </div>";
        }
        rawQuery30.close();
        rawQuery28.close();
        ...
        if (rawQuery32.getCount() > 0) {
            ...
            this.hobbi = "<div class='w3-no-break w3-row w3-brdr-lft w3-margin-bottom'>    <h6 class='t7-block_background w3-padding-tinysmall w3-upper-case'>" + str21 + "</h6>    <div class='w3-container'>" + this.sub_hobbi + "    </div></div>";
        }
        rawQuery32.close();
        ...
        if (rawQuery34.getCount() > 0) {
            ...
            this.reference = "<div class='w3-no-break w3-row w3-brdr-lft w3-margin-bottom'>        <h6 class='t7-block_background w3-padding-tinysmall w3-upper-case'>" + str22 + "</h6>        <div class='w3-container'>" + this.sub_refer + "        </div>    </div>";
        }
        rawQuery34.close();
    }

    public String resueme() {
        return "<!DOCTYPE html><html>    <title>NithrA - Resume Template 11</title>    <meta charset='UTF-8'>    <link rel='stylesheet' href='css/11.css'>    <link rel='stylesheet' href='css/font-awesome.min.css'>    <style>        @page { size: A4 portrait;margin: 7.5mm 2.5mm 7.5mm 7.5mm;cover-letter {page-break-after: always;}}    </style>    <body class='w3-templete_background'>        <div class='w3-content' style='max-width:1400px;'>" + this.cover_letter + "            <div class='w3-no-break w3-row w3-container w3-top-background w3-brdr-lft w3-margin'>                " + this.image + this.personal + "            </div>            <div class='w3-row w3-container'>" + this.objective + this.education + this.experience + this.project + this.intrest + this.skill + this.explore + this.achive + this.curricular + this.strength + this.hobbi + this.info + this.reference + this.declar + "                <div class='w3-row'>                                <h6>                                    <table>                                        <tr><td width='7%'>Date</td><td width='1%'> : </td><td width='84.5%'>" + this.date + "</td><td>Signature,</td></tr>                                        <tr><td width='7%'>Place</td><td  width='1%'> : </td><td width='80%'>" + this.place + "</td>" + this.sign + "</tr>                                                                           </table>                                </h6>" + this.sign_btm_name + "         </table>      </h6>                </div>            </div>        </div>    </body></html>";
    }
    ...
    public void createPdfFile() {
        try {
            ...
            new PdfWriter(getApplicationContext(), this.mWebView.createPrintDocumentAdapter(), createEmptyFile).write(new PdfWriter.PdfWriterCallback() {
                /* class nithra.resume.maker.cv.builder.app.Formates.Format_11.AnonymousClass6 */

                @Override // nithra.resume.maker.cv.builder.app.PdfWriter.PdfWriterCallback
                public void onWriteFinished() {
                    Format_11.this.wait_dialog.dismiss();
                    Toast.makeText(Format_11.this.getApplicationContext(), "Resume generated successfully", 0).show();
                    Uri fromFile = Uri.fromFile(new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM) + "/Nithra/ResumeBuilder/" + Format_11.this.fileName));
                    Intent intent = new Intent("android.intent.action.VIEW");
                    intent.setFlags(67108864);
                    intent.setDataAndType(fromFile, "application/pdf");
                    try {
                        Format_11.this.startActivity(intent);
                    } catch (ActivityNotFoundException unused) {
                        Utils.toast_center(Format_11.this, "No Application available to view PDF");
                    }
                }
    ...
    private File createEmptyFile() throws IOException {
        this.fileName = this.sp.getString(this, "profile_name") + "_Perfect Resume.pdf";
    ...
    public void PermissionFun() {
        if (Build.VERSION.SDK_INT < 23) {
            ...
            textView.setOnClickListener(new View.OnClickListener() {
                /* class nithra.resume.maker.cv.builder.app.Formates.Format_11.AnonymousClass7 */

                @SuppressLint({"NewApi"})
                public void onClick(View view) {
                    if (Format_11.this.sp.getInt(Format_11.this, "permissiond") == 2) {
                        Intent intent = new Intent();
                        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        intent.setAction("android.settings.APPLICATION_DETAILS_SETTINGS");
                        intent.setData(Uri.fromParts("package", Format_11.this.getPackageName(), null));
                        Format_11.this.startActivity(intent);
                        dialog.dismiss();
                        return;
                    }
                    Format_11.this.requestPermissions(new String[]{"android.permission.WRITE_EXTERNAL_STORAGE"}, 151);
                    dialog.dismiss();
                }
            });
            dialog.show();
    ...
    public void openDialog(boolean z) {
        new AmbilWarnaDialog(this, this.color, z, new AmbilWarnaDialog.OnAmbilWarnaListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_11.AnonymousClass8 */

            @Override // nithra.resume.maker.cv.builder.app.color.AmbilWarnaDialog.OnAmbilWarnaListener
            public void onOk(AmbilWarnaDialog ambilWarnaDialog, int i) {
                Toast.makeText(Format_11.this, "ok", 0).show();
                Format_11 format_11 = Format_11.this;
                format_11.color = i;
                format_11.displayColor();
                if (Format_11.this.color_dialog.isShowing()) {
                    Format_11.this.color_dialog.dismiss();
                }
            }

            @Override // nithra.resume.maker.cv.builder.app.color.AmbilWarnaDialog.OnAmbilWarnaListener
            public void onCancel(AmbilWarnaDialog ambilWarnaDialog) {
                Toast.makeText(Format_11.this, "cancel", 0).show();
            }
        }).show();
    }
    ...
    public void onResume() {
        ...
        if (new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM).getPath() + "/Nithra/ResumeBuilder/" + this.sp.getString(this, "profile_name") + "_Perfect Resume.pdf").exists()) {
