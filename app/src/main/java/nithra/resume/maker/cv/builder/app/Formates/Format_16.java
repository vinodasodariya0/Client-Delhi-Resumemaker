...
public class Format_16 extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        ((AppCompatTextView) findViewById(R.id.title_name)).setText("Modern Resume");
        ...
        this.mWebView.setOnLongClickListener(new View.OnLongClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_16.AnonymousClass1 */
        ...
        this.save.setOnClickListener(new View.OnClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_16.AnonymousClass2 */

            public void onClick(View view) {
                if (Format_16.this.sp.getInt(Format_16.this, "permissiond") == 1) {
                    try {
                    ...
                    Format_16.this.createPdfFile();
                    Format_16.this.wait_dialog.show();
                    return;
                }
                Format_16.this.PermissionFun();
            }
        });
        this.picker.setOnClickListener(new View.OnClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_16.AnonymousClass3 */

            public void onClick(View view) {
                if (Format_16.this.sp.getInt(Format_16.this, "key") == 0) {
                    Format_16.this.sp.putString(Format_16.this, "type", "text");
                    Format_16.this.openDialog(false);
                } else if (Format_16.this.sp.getInt(Format_16.this, "key") == 1) {
                    Format_16.this.color_dialog.show();
                } else if (Format_16.this.sp.getInt(Format_16.this, "key") == 2) {
                    Format_16.this.color_dialog.show();
                } else if (Format_16.this.sp.getInt(Format_16.this, "key") == 3) {
                    Format_16.this.sp.putString(Format_16.this, "type", "text");
                    Format_16.this.openDialog(false);
                } else if (Format_16.this.sp.getInt(Format_16.this, "key") == 4) {
                    Format_16.this.sp.putString(Format_16.this, "type", "text");
                    Format_16.this.openDialog(false);
                } else if (Format_16.this.sp.getInt(Format_16.this, "key") == 5) {
                    Format_16.this.sp.putString(Format_16.this, "type", "text");
                    Format_16.this.openDialog(false);
                } else if (Format_16.this.sp.getInt(Format_16.this, "key") == 6) {
                    Format_16.this.sp.putString(Format_16.this, "type", "text");
                    Format_16.this.openDialog(false);
                } else if (Format_16.this.sp.getInt(Format_16.this, "key") == 7) {
                    Format_16.this.sp.putString(Format_16.this, "type", "text");
                    Format_16.this.openDialog(false);
                } else if (Format_16.this.sp.getInt(Format_16.this, "key") == 8) {
                    Format_16.this.sp.putString(Format_16.this, "type", "text");
                    Format_16.this.openDialog(false);
                }
            }
        ...
        ((LinearLayout) this.color_dialog.findViewById(R.id.text_lay)).setOnClickListener(new View.OnClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_16.AnonymousClass4 */
        ...
        ((LinearLayout) this.color_dialog.findViewById(R.id.border_lay)).setOnClickListener(new View.OnClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_16.AnonymousClass5 */

            public void onClick(View view) {
                Format_16.this.sp.putString(Format_16.this, "type", "bg");
                Format_16.this.openDialog(false);
            }
        });
    ...
    private void first_load() {
        ...
        if (rawQuery.getCount() > 0) {
            ...
            if (string15.equals("") || string15.equals("null")) {
                this.image = " <div class='w3-display-container w3-img-div w3-padding-24'>     <img class='w3-profile-image' src='" + "man.png" + "' id='image' alt='Avatar'>                         </div>";
            } else if (this.sp.getBoolean(this, "photo_check").booleanValue()) {
                this.image = " <div class='w3-display-container w3-img-div w3-padding-24'>     <img class='w3-profile-image' src='" + string15 + "' id='image' alt='Avatar'>                         </div>";
            } else {
                this.image = " <div class='w3-display-container w3-img-div w3-padding-24'>     <img class='w3-profile-image' src='" + "man.png" + "' id='image' alt='Avatar'>                         </div>";
            }
        ...
        if (rawQuery2.getCount() > 0) {
            ...
            if (rawQuery4.getCount() > 0) {
                ...
                this.info = "<div class='w3-container w3-white'>       <h2 class='w3-capitalize w3-text-templete_color_1'>" + this.title + "</h2>       <div class='w3-container'>" + this.pro_table + "       </div>   </div>";
            }
            rawQuery4.close();
            String str4 = "<table><tr>" + str + str2 + "</tr>" + str3 + "</table>";
            this.personal = "<div class='w3-no-break w3-container w3-white'>       <h1 class='w3-padding-top w3-margin-bottom-0 name-line-ht-25 w3-capitalize w3-text-templete_color_1'>" + this.name + "</h1>       <hr style='margin: 0; border: 1px solid #000;'>       <div class='w3-container'>           <p class='font-weight-500 margin-5'> " + this.email + "</p>           <p class='font-weight-500 margin-5'> " + this.phoneno + "</p>           <p class='font-weight-500 margin-5'> " + this.address.replaceAll("<p dir=\"ltr\">", "").replaceAll("</p>", "").replaceAll("<br>", "") + "</p>       </div>   </div>";
        }
        rawQuery2.close();
        if (this.sp.getBoolean(this, "sign_name_check").booleanValue()) {
            ...
            this.sign_btm_name = "<h6 style='text-align:right;width: 85%;'>( " + this.name + ")</h6>";
        } else {
            this.sign_name = "";
            this.sign_btm_name = "";
        }
        ...
        if (rawQuery6.getCount() > 0) {
            ...
            if (!string20.equals("")) {
                this.objective = "<div class='w3-container w3-white'>       <h2 class='w3-capitalize w3-text-templete_color_1'>Objective</h2>       <div class='w3-container'>           <p class=''>" + string20 + "</p>       </div>   </div>";
            }
            if (!string21.equals("")) {
                this.declar = " <h2 class='w3-capitalize w3-text-templete_color_1'>Declaration</h2> <div class='w3-container'>     <p class=''>" + string21 + "</p>                                                                 </div>";
            }
        }
        ...
        if (rawQuery7.getCount() > 0) {
            ...
            for (int i2 = 0; i2 < rawQuery7.getCount(); i2++) {
                ...
                rawQuery9.close();
                this.sub_exp += "<h6 class='w3-margin-top-2 w3-margin-bottom-0'><b>" + string25 + "</b></h6>             <p class='w3-margin-top-0 w3-margin-bottom-0'><b>Designation : </b><b>" + string24 + ", " + string22 + " - " + string23 + "</b></p>                        " + ((string26.equals("") || string26.equals(null)) ? "" : "<p class='w3-margin-top-0 w3-margin-bottom-0'><b>Role : </b>" + string26 + "</p>") + str6;
                rawQuery7.moveToNext();
            }
            this.experience = "<div class='w3-container w3-white'>        <h2 class='w3-capitalize w3-text-templete_color_1'>" + str5 + "</h2>        <div class='w3-container'>" + this.sub_exp + "        </div>    </div>";
        } else {
        ...
        if (rawQuery10.getCount() > 0) {
            ...
            for (int i5 = 0; i5 < rawQuery10.getCount(); i5++) {
                ...
                rawQuery12.close();
                this.sub_work += "<h6 class='w3-margin-top-2 w3-margin-bottom-0'><b>" + string27 + "</b></h6>          <p class='w3-margin-top-0 w3-margin-bottom-0'><b>Description : </b>" + string28 + "</p>          <p class='w3-margin-top-0 w3-margin-bottom-0'><b>Duration : </b>" + string29 + " &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; " + str8 + "          <p class='w3-margin-top-0 w3-margin-bottom-0'><b>Role : </b>" + string30 + "</p>" + string32 + str9;
                rawQuery10.moveToNext();
            }
            this.project = "<div class='w3-container w3-white'>     <h2 class='w3-capitalize w3-text-templete_color_1'>" + str7 + "</h2>     <div class='w3-container'>" + this.sub_work + "     </div> </div>";
        }
        rawQuery10.close();
        ...
        if (rawQuery13.getCount() > 0) {
            ...
            for (int i8 = 0; i8 < rawQuery13.getCount(); i8++) {
                ...
                rawQuery15.close();
                this.sub_edu += "<h6 class='w3-margin-top-2 w3-margin-bottom-0'><b>" + string33 + "</b></h6>            <p class='w3-margin-top-0 w3-margin-bottom-0'>" + string34 + ", <b>" + string35 + "</b>,<b> " + string36 + "</b></p>" + str11;
                rawQuery13.moveToNext();
            }
            this.education = "<div class='w3-container w3-white'>       <h2 class='w3-capitalize w3-text-templete_color_1'>" + str10 + "</h2>       <div class='w3-container'>" + this.sub_edu + "       </div>   </div>";
        }
        rawQuery13.close();
        ...
        if (rawQuery16.getCount() > 0) {
            ...
            this.skill = " <div class='w3-no-break w3-padding-left-20'>     <p class='w3-large w3-capitalize green'><b>" + str13 + "</b></p>     <ul class='w3-large ul-margin-0' style='list-style: none;color: white;'>" + this.sub_skill + "     </ul>     <br> </div>";
        }
        rawQuery16.close();
        ...
        if (rawQuery18.getCount() > 0) {
            ...
            this.strength = "<div class='w3-container w3-white'>     <h2 class='w3-capitalize w3-text-templete_color_1'>" + str14 + "</h2>     <div class='w3-container'>" + this.sub_strength + "     </div> </div>";
        }
        rawQuery18.close();
        ...
        if (rawQuery20.getCount() > 0) {
            ...
            this.intrest = " <div class='w3-no-break w3-padding-left-20'>     <p class='w3-large w3-capitalize green w3-margin-top-0'><b>" + str15 + "</b></p>     <ul class='w3-large' style='list-style: none;color: white;'>" + this.sub_intrest + "     </ul>     <br> </div>";
        }
        rawQuery20.close();
        ...
        if (rawQuery24.getCount() > 0) {
            ...
            for (int i15 = 0; i15 < rawQuery24.getCount(); i15++) {
                this.sub_inplant += "<h6 class='font-weight-500'>" + rawQuery24.getString(rawQuery24.getColumnIndex("inplant")) + "</h6>";
                rawQuery24.moveToNext();
            }
            this.inplant = "  <h5><b>" + str17 + " : </b></h5>" + this.sub_inplant;
        }
        if (rawQuery24.getCount() > 0 || rawQuery22.getCount() > 0) {
            this.explore = "<div class='w3-container w3-white'>     <h2 class='w3-capitalize w3-text-templete_color_1'>Industrial Exposure</h2>     <div class='w3-container'>" + this.indrust + this.inplant + "     </div>                             </div>";
        }
        rawQuery24.close();
        rawQuery22.close();
        ...
        if (rawQuery26.getCount() > 0) {
            ...
            this.achive = "<div class='w3-container w3-white'>    <h2 class='w3-capitalize w3-text-templete_color_1'>" + str18 + "</h2>    <div class='w3-container'>" + this.sub_achive + "    </div></div>";
        }
        rawQuery26.close();
        ...
        if (rawQuery30.getCount() > 0 || rawQuery28.getCount() > 0) {
            this.curricular = " <div class='w3-container w3-white'>     <h2 class='w3-capitalize w3-text-templete_color_1'>Curricular Activities</h2>     <div class='w3-container'>" + this.cocuri + this.extra + "     </div>                             </div>";
        }
        rawQuery30.close();
        rawQuery28.close();
        ...
        if (rawQuery32.getCount() > 0) {
            ...
            this.hobbi = "<div class='w3-container w3-white'>    <h2 class='w3-capitalize w3-text-templete_color_1'>" + str21 + "</h2>    <div class='w3-container'>" + this.sub_hobbi + "    </div>                            </div>";
        }
        rawQuery32.close();
            ...
            for (int i20 = 0; i20 < rawQuery34.getCount(); i20++) {
                ...
                if (rawQuery36.getCount() > 0) {
                    ...
                    for (int i22 = 0; i22 < rawQuery36.getCount(); i22++) {
                        str24 = str24 + "<h6 class='w3-margin-top-0 font-weight-500  w3-margin-bottom-0'><b>" + rawQuery36.getString(rawQuery36.getColumnIndex("title")) + " : </b> " + rawQuery36.getString(rawQuery36.getColumnIndex("value")) + "</h6>";
                        rawQuery36.moveToNext();
                    }
                    str23 = str24;
                }
                rawQuery36.close();
                this.sub_refer += "<h5 class='w3-margin-top-2 w3-margin-bottom-0'><b>" + string37 + "</b></h5>            <h6 class='w3-margin-top-0 font-weight-500  w3-margin-bottom-0'>" + string38 + "</h6>            <h6 class='w3-margin-top-0 font-weight-500  w3-margin-bottom-0'>" + string39 + "</h6>            <h6 class='w3-margin-top-0 font-weight-500  w3-margin-bottom-0'>" + string40 + "</h6>            <h6 class='w3-margin-top-0 font-weight-500  w3-margin-bottom-0'>" + string41 + "</h6>" + str23;
                rawQuery34.moveToNext();
            }
            this.reference = "<div class='w3-container w3-white'>      <h2 class='w3-capitalize w3-text-templete_color_1'>" + str22 + "</h2>      <div class='w3-container '>" + this.sub_refer + "      </div>                              </div>";
        }
        rawQuery34.close();
    }

    public String resueme() {
        return "<!DOCTYPE html><html>    <title>NithrA - Resume Template 16</title>    <meta charset='UTF-8'>    <link rel='stylesheet' href='css/16.css'>    <link rel='stylesheet' href='css/font-awesome.min.css'>    <style>        @page { size: A4 portrait;margin: 4mm;}        html,body,h1,h2,h3,h4,h5,h6 {font-family: 'twcent', sans-serif}    </style>    <body class=''>        <div class='w3-content' style='max-width:1400px;'>" + this.cover_letter + "            <div class='w3-row w3-padding w3-templete_color_1'> <div class='color-div'>               <div class='w3-third'>" + this.image + "                    <div class='w3-container w3-txt-div'>                                            " + this.skill + this.intrest + "                    </div><br>                </div>                <div class='w3-twothird w3-templete_color_1'>                    <div class='main-content w3-white'>" + this.personal + this.objective + this.education + this.experience + this.project + this.explore + this.achive + this.curricular + this.strength + this.hobbi + this.info + this.reference + "                </div>                        <div class='w3-container w3-white'>" + this.declar + "                            <div class='w3-container'>                                                                <h6>                                    <table>                                        <tr><td width='7%'>Date</td><td width='1%'> : </td><td width='84.5%'>" + this.date + "</td><td>Signature,</td></tr>                                        <tr><td width='7%'>Place</td><td  width='1%'> : </td><td width='80%'>" + this.place + "</td>" + this.sign + "</tr>                                                                           </table>                                </h6>" + this.sign_btm_name + "                                 </div>                        </div>                    </div>                </div>            </div>        </div>    </body></html>";
    }
    ...
    public void createPdfFile() {
        try {
            ...
            new PdfWriter(getApplicationContext(), this.mWebView.createPrintDocumentAdapter(), createEmptyFile).write(new PdfWriter.PdfWriterCallback() {
                /* class nithra.resume.maker.cv.builder.app.Formates.Format_16.AnonymousClass6 */

                @Override // nithra.resume.maker.cv.builder.app.PdfWriter.PdfWriterCallback
                public void onWriteFinished() {
                    Format_16.this.wait_dialog.dismiss();
                    Toast.makeText(Format_16.this.getApplicationContext(), "Resume generated successfully", 0).show();
                    Uri fromFile = Uri.fromFile(new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM) + "/Nithra/ResumeBuilder/" + Format_16.this.fileName));
                    Intent intent = new Intent("android.intent.action.VIEW");
                    intent.setFlags(67108864);
                    intent.setDataAndType(fromFile, "application/pdf");
                    try {
                        Format_16.this.startActivity(intent);
                    } catch (ActivityNotFoundException unused) {
                        Utils.toast_center(Format_16.this, "No Application available to view PDF");
                    }
                }
    ...
    private File createEmptyFile() throws IOException {
        this.fileName = this.sp.getString(this, "profile_name") + "_Modern Resume.pdf";
    ...
    public void PermissionFun() {
        if (Build.VERSION.SDK_INT < 23) {
            ...
            textView.setOnClickListener(new View.OnClickListener() {
                /* class nithra.resume.maker.cv.builder.app.Formates.Format_16.AnonymousClass7 */

                @SuppressLint({"NewApi"})
                public void onClick(View view) {
                    if (Format_16.this.sp.getInt(Format_16.this, "permissiond") == 2) {
                        Intent intent = new Intent();
                        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        intent.setAction("android.settings.APPLICATION_DETAILS_SETTINGS");
                        intent.setData(Uri.fromParts("package", Format_16.this.getPackageName(), null));
                        Format_16.this.startActivity(intent);
                        dialog.dismiss();
                        return;
                    }
                    Format_16.this.requestPermissions(new String[]{"android.permission.WRITE_EXTERNAL_STORAGE"}, 151);
                    dialog.dismiss();
                }
            });
            dialog.show();
    ...
    public void openDialog(boolean z) {
        new AmbilWarnaDialog(this, this.color, z, new AmbilWarnaDialog.OnAmbilWarnaListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_16.AnonymousClass8 */

            @Override // nithra.resume.maker.cv.builder.app.color.AmbilWarnaDialog.OnAmbilWarnaListener
            public void onOk(AmbilWarnaDialog ambilWarnaDialog, int i) {
                Toast.makeText(Format_16.this, "ok", 0).show();
                Format_16 format_16 = Format_16.this;
                format_16.color = i;
                format_16.displayColor();
                if (Format_16.this.color_dialog.isShowing()) {
                    Format_16.this.color_dialog.dismiss();
                }
            }

            @Override // nithra.resume.maker.cv.builder.app.color.AmbilWarnaDialog.OnAmbilWarnaListener
            public void onCancel(AmbilWarnaDialog ambilWarnaDialog) {
                Toast.makeText(Format_16.this, "cancel", 0).show();
            }
        }).show();
    }
    ...
    public void onResume() {
        ...
        if (new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM).getPath() + "/Nithra/ResumeBuilder/" + this.sp.getString(this, "profile_name") + "_Modern Resume.pdf").exists()) {
