...
public class Format_17 extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        ((AppCompatTextView) findViewById(R.id.title_name)).setText("Spick and Span Resume");
        ...
        this.mWebView.setOnLongClickListener(new View.OnLongClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_17.AnonymousClass1 */
        ...
        this.save.setOnClickListener(new View.OnClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_17.AnonymousClass2 */

            public void onClick(View view) {
                if (Format_17.this.sp.getInt(Format_17.this, "permissiond") == 1) {
                    try {
                    ...
                    Format_17.this.createPdfFile();
                    Format_17.this.wait_dialog.show();
                    return;
                }
                Format_17.this.PermissionFun();
            }
        });
        this.picker.setOnClickListener(new View.OnClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_17.AnonymousClass3 */

            public void onClick(View view) {
                if (Format_17.this.sp.getInt(Format_17.this, "key") == 0) {
                    Format_17.this.sp.putString(Format_17.this, "type", "text");
                    Format_17.this.openDialog(false);
                } else if (Format_17.this.sp.getInt(Format_17.this, "key") == 1) {
                    Format_17.this.color_dialog.show();
                } else if (Format_17.this.sp.getInt(Format_17.this, "key") == 2) {
                    Format_17.this.color_dialog.show();
                } else if (Format_17.this.sp.getInt(Format_17.this, "key") == 3) {
                    Format_17.this.sp.putString(Format_17.this, "type", "text");
                    Format_17.this.openDialog(false);
                } else if (Format_17.this.sp.getInt(Format_17.this, "key") == 4) {
                    Format_17.this.sp.putString(Format_17.this, "type", "text");
                    Format_17.this.openDialog(false);
                } else if (Format_17.this.sp.getInt(Format_17.this, "key") == 5) {
                    Format_17.this.sp.putString(Format_17.this, "type", "text");
                    Format_17.this.openDialog(false);
                } else if (Format_17.this.sp.getInt(Format_17.this, "key") == 6) {
                    Format_17.this.sp.putString(Format_17.this, "type", "text");
                    Format_17.this.openDialog(false);
                } else if (Format_17.this.sp.getInt(Format_17.this, "key") == 7) {
                    Format_17.this.sp.putString(Format_17.this, "type", "text");
                    Format_17.this.openDialog(false);
                } else if (Format_17.this.sp.getInt(Format_17.this, "key") == 8) {
                    Format_17.this.sp.putString(Format_17.this, "type", "text");
                    Format_17.this.openDialog(false);
                }
            }
        ...
        ((LinearLayout) this.color_dialog.findViewById(R.id.text_lay)).setOnClickListener(new View.OnClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_17.AnonymousClass4 */
        ...
        ((LinearLayout) this.color_dialog.findViewById(R.id.border_lay)).setOnClickListener(new View.OnClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_17.AnonymousClass5 */

            public void onClick(View view) {
                Format_17.this.sp.putString(Format_17.this, "type", "bg");
                Format_17.this.openDialog(false);
            }
        });
    ...
    private void first_load() {
        ...
        if (rawQuery.getCount() > 0) {
            ...
            if (string15.equals("") || string15.equals("null")) {
                this.image = " <div class='w3-quarter t3-profile1'>     <img class='t3-profile-image' src='" + "man.png" + "' id='image' alt='Avatar'>                         </div>";
            } else if (this.sp.getBoolean(this, "photo_check").booleanValue()) {
                this.image = " <div class='w3-quarter t3-profile1'>     <img class='t3-profile-image' src='" + string15 + "' id='image' alt='Avatar'>                         </div>";
            } else {
                this.image = " <div class='w3-quarter t3-profile1'>     <img class='t3-profile-image' src='" + "man.png" + "' id='image' alt='Avatar'>                         </div>";
            }
        ...
        if (rawQuery2.getCount() > 0) {
            ...
            if (rawQuery4.getCount() > 0) {
                ...
                this.info = "<div class='w3-no-break w3-row w3-container'>        <h5 class='w3-quarter t4-right t3-headeing-color'><b>" + this.title + "</b></h5>        <div class='w3-threequarter t4-right w3-container padding-left-14'>" + this.pro_table + "        </div>    </div>";
            }
            rawQuery4.close();
            String str4 = "<table><tr>" + str + str2 + "</tr>" + str3 + "</table>";
            this.personal = "<div class='w3-threequarter t3-right padding-left-20 txt-right'>       <h2 class='w3-upper-case t3-profile-name w3-margin-bottom-0'>" + this.name + "</h2>       <h6 class='t3-profile-address w3-margin-top-0'>" + this.address.replaceAll("<br>", "") + "</h6>       <h6 class='t3-profile-detail w3-margin-top-0'>" + this.phoneno + "</h6>       <h6 class='t3-profile-detail w3-margin-top-0'> " + this.email + "</h6>   </div>";
        }
        rawQuery2.close();
        if (this.sp.getBoolean(this, "sign_name_check").booleanValue()) {
            this.sign_name = "<tr><td width='85%'></td><td class='w3-center'><h6>(" + this.name + ")</h6></td></tr>";
            this.sign_btm_name = "<h6 style='text-align:right;width: 90%;'>( " + this.name + ")</h6>";
        } else {
            this.sign_name = "";
            this.sign_btm_name = "";
        }
        ...
        if (rawQuery6.getCount() > 0) {
            ...
            if (!string20.equals("")) {
                this.objective = "<div class='w3-no-break w3-row w3-container'>        <h5 class='w3-quarter t4-right t3-headeing-color'><b>Objective</b></h5>        <div class='w3-threequarter t4-right w3-container padding-left-14'>            <p>" + string20 + "</p>        </div>    </div>";
            }
            if (!string21.equals("")) {
                this.declar = "  <h5 class='w3-quarter t4-right t3-headeing-color'><b>Declaration</b></h5>  <div class='w3-threequarter t4-right w3-container padding-left-14'>      <h6>" + string21 + "</h6>      <br>  </div>";
            }
        }
            ...
            for (int i2 = 0; i2 < rawQuery7.getCount(); i2++) {
                ...
                if (rawQuery9.getCount() > 0) {
                    for (int i4 = 0; i4 < rawQuery9.getCount(); i4++) {
                        str6 = str6 + "<p class='w3-margin-top-0 w3-margin-bottom-0'><b>" + rawQuery9.getString(rawQuery9.getColumnIndex("title")) + " : </b>" + rawQuery9.getString(rawQuery9.getColumnIndex("value")) + "</p>";
                        rawQuery9.moveToNext();
                    }
                }
                rawQuery9.close();
                this.sub_exp += "<h6 class='w3-margin-bottom-0'><b>" + string25 + "</b></h6>             <p class='w3-margin-top-0 w3-margin-bottom-0'><b>Designation : </b><b>" + string24 + ", " + string22 + " - " + string23 + "</b></p>                        " + ((string26.equals("") || string26.equals(null)) ? "" : "<p class='w3-margin-top-0 w3-margin-bottom-0'><b>Role : </b>" + string26 + "</p>") + str6;
                rawQuery7.moveToNext();
            }
            this.experience = "<div class='w3-no-break w3-row w3-container'>        <h5 class='w3-quarter t4-right t3-headeing-color'><b>" + str5 + "</b></h5>        <div class='w3-threequarter t4-right w3-container padding-left-14'>" + this.sub_exp + "        </div>    </div>";
        } else {
        ...
        if (rawQuery10.getCount() > 0) {
            ...
            this.project = "<div class='w3-no-break w3-row w3-container'>      <h5 class='w3-quarter t4-right t3-headeing-color'><b>" + str7 + "</b></h5>      <div class='w3-threequarter t4-right w3-container padding-left-14'>" + this.sub_work + "      </div>  </div>";
        }
        rawQuery10.close();
        ...
        if (rawQuery13.getCount() > 0) {
            ...
            this.education = "<div class='w3-no-break w3-row w3-container'>       <h5 class='w3-quarter t4-right t3-headeing-color'><b>" + str10 + "</b></h5>       <div class='w3-threequarter t4-right w3-container padding-left-14'>" + this.sub_edu + "       </div>   </div>";
        }
        rawQuery13.close();
        ...
        if (rawQuery16.getCount() > 0) {
            ...
            for (int i11 = 0; i11 < rawQuery16.getCount(); i11++) {
                this.sub_skill += "<h6>" + rawQuery16.getString(rawQuery16.getColumnIndex("skill")) + "</h6>";
                rawQuery16.moveToNext();
            }
            this.skill = "<div class='w3-no-break w3-row w3-container'>    <h5 class='w3-quarter t4-right t3-headeing-color'><b>" + str13 + "</b></h5>    <div class='w3-threequarter t4-right w3-container padding-left-14'>" + this.sub_skill + "    </div></div>";
        }
        rawQuery16.close();
        ...
        if (rawQuery18.getCount() > 0) {
            ...
            for (int i12 = 0; i12 < rawQuery18.getCount(); i12++) {
                this.sub_strength += "<h6>" + rawQuery18.getString(rawQuery18.getColumnIndex("strength")) + "</h6>";
                rawQuery18.moveToNext();
            }
            this.strength = "<div class='w3-no-break w3-row w3-container'>      <h5 class='w3-quarter t4-right t3-headeing-color'><b>" + str14 + "</b></h5>      <div class='w3-threequarter t4-right w3-container padding-left-14'>" + this.sub_strength + "      </div>  </div>";
        }
        rawQuery18.close();
        ...
        if (rawQuery20.getCount() > 0) {
            ...
            for (int i13 = 0; i13 < rawQuery20.getCount(); i13++) {
                this.sub_intrest += "<h6>" + rawQuery20.getString(rawQuery20.getColumnIndex("interest")) + "</h6>";
                rawQuery20.moveToNext();
            }
            this.intrest = " <div class='w3-no-break w3-row w3-container'>     <h5 class='w3-quarter t4-right t3-headeing-color'><b>" + str15 + "</b></h5>     <div class='w3-threequarter t4-right w3-container padding-left-14'>" + this.sub_intrest + "     </div> </div>";
        }
        rawQuery20.close();
        ...
        if (rawQuery24.getCount() > 0 || rawQuery22.getCount() > 0) {
            this.explore = " <div class='w3-no-break w3-row w3-container'>     <h5 class='w3-quarter t4-right t3-headeing-color'><b>Industrial Exposure</b></h5>     <div class='w3-threequarter t4-right w3-container padding-left-14'>" + this.indrust + this.inplant + "     </div> </div>";
        }
        rawQuery24.close();
        rawQuery22.close();
        ...
        if (rawQuery26.getCount() > 0) {
            ...
            this.achive = " <div class='w3-no-break w3-row w3-container'>     <h5 class='w3-quarter t4-right t3-headeing-color'><b>" + str18 + "</b></h5>     <div class='w3-threequarter t4-right w3-container padding-left-14'>" + this.sub_achive + "     </div> </div>";
        }
        rawQuery26.close();
        ...
        if (rawQuery28.getCount() > 0) {
            ...
            for (int i17 = 0; i17 < rawQuery28.getCount(); i17++) {
                this.sub_cocuri += "<h6>" + rawQuery28.getString(rawQuery28.getColumnIndex("cocurricular")) + "</h6>";
        ...
        if (rawQuery30.getCount() > 0) {
            ...
            for (int i18 = 0; i18 < rawQuery30.getCount(); i18++) {
                this.sub_extra += "<h6>" + rawQuery30.getString(rawQuery30.getColumnIndex("extracurricular")) + "</h6>";
                rawQuery30.moveToNext();
            }
            this.extra = " <h5><b>" + str20 + " : </b></h5>" + this.sub_extra;
        }
        if (rawQuery30.getCount() > 0 || rawQuery28.getCount() > 0) {
            this.curricular = "<div class='w3-no-break w3-row w3-container'>         <h5 class='w3-quarter t4-right t3-headeing-color'><b>Curricular Activities</b></h5>         <div class='w3-threequarter t4-right w3-container padding-left-14'>" + this.cocuri + this.extra + "         </div>     </div>";
        }
        rawQuery30.close();
        rawQuery28.close();
        ...
        if (rawQuery32.getCount() > 0) {
            ...
            for (int i19 = 0; i19 < rawQuery32.getCount(); i19++) {
                this.sub_hobbi += "<h6>" + rawQuery32.getString(rawQuery32.getColumnIndex("hobbies")) + "</h6>";
                rawQuery32.moveToNext();
            }
            this.hobbi = "  <div class='w3-no-break w3-row w3-container'>      <h5 class='w3-quarter t4-right t3-headeing-color'><b>" + str21 + "</b></h5>      <div class='w3-threequarter t4-right w3-container padding-left-14'>" + this.sub_hobbi + "      </div>  </div>";
        }
        rawQuery32.close();
        ...
        if (rawQuery34.getCount() > 0) {
            ...
            this.reference = "<div class='w3-no-break w3-row w3-container'>       <h5 class='w3-quarter t4-right t3-headeing-color'><b>" + str22 + "</b></h5>       <div class='w3-threequarter t4-right w3-container padding-left-14'>" + this.sub_refer + "       </div>   </div>";
        }
        rawQuery34.close();
    }

    public String resueme() {
        return "<!DOCTYPE html><html>    <title>NithrA - Resume Template 17</title>    <meta charset='UTF-8'>    <link rel='stylesheet' href='css/17.css'>    <link rel='stylesheet' href='css/font-awesome.min.css'>    <style>        @page { size: A4 portrait;margin: 1mm;}    </style>    <body class='' style='padding: 10px 20px; background: #fff;'>        <div class='w3-content ' style='max-width:1400px;'>" + this.cover_letter + "       </div>       <div class='w3-templete_background w3-content ' style='max-width:1400px;'>            <div class='w3-row w3-margin-60'>                <div class='w3-no-break w3-row w3-container w3-top-background w3-margin-custom'>" + this.image + this.personal + "                </div>" + this.objective + this.education + this.experience + this.project + this.intrest + this.skill + this.explore + this.achive + this.curricular + this.strength + this.hobbi + this.info + this.reference + "                <div class='w3-no-break w3-row w3-container'>" + this.declar + "                    <div class='w3-row'>                                <h6>                                    <table>                                        <tr><td width='7%'>Date</td><td width='1%'> : </td><td width='84.5%'>" + this.date + "</td><td>Signature,</td></tr>                                        <tr><td width='7%'>Place</td><td  width='1%'> : </td><td width='80%'>" + this.place + "</td>" + this.sign + "</tr>                                                                           </table>                                </h6>" + this.sign_btm_name + "                         </div>                </div>            </div>        </div>    </body></html>";
    }
    ...
    public void createPdfFile() {
        try {
            ...
            new PdfWriter(getApplicationContext(), this.mWebView.createPrintDocumentAdapter(), createEmptyFile).write(new PdfWriter.PdfWriterCallback() {
                /* class nithra.resume.maker.cv.builder.app.Formates.Format_17.AnonymousClass6 */

                @Override // nithra.resume.maker.cv.builder.app.PdfWriter.PdfWriterCallback
                public void onWriteFinished() {
                    Format_17.this.wait_dialog.dismiss();
                    Toast.makeText(Format_17.this.getApplicationContext(), "Resume generated successfully", 0).show();
                    Uri fromFile = Uri.fromFile(new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM) + "/Nithra/ResumeBuilder/" + Format_17.this.fileName));
                    Intent intent = new Intent("android.intent.action.VIEW");
                    intent.setFlags(67108864);
                    intent.setDataAndType(fromFile, "application/pdf");
                    try {
                        Format_17.this.startActivity(intent);
                    } catch (ActivityNotFoundException unused) {
                        Utils.toast_center(Format_17.this, "No Application available to view PDF");
                    }
                }
    ...
    private File createEmptyFile() throws IOException {
        this.fileName = this.sp.getString(this, "profile_name") + "_Spick and Span Resume.pdf";
    ...
    public void PermissionFun() {
        if (Build.VERSION.SDK_INT < 23) {
            ...
            textView.setOnClickListener(new View.OnClickListener() {
                /* class nithra.resume.maker.cv.builder.app.Formates.Format_17.AnonymousClass7 */

                @SuppressLint({"NewApi"})
                public void onClick(View view) {
                    if (Format_17.this.sp.getInt(Format_17.this, "permissiond") == 2) {
                        Intent intent = new Intent();
                        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        intent.setAction("android.settings.APPLICATION_DETAILS_SETTINGS");
                        intent.setData(Uri.fromParts("package", Format_17.this.getPackageName(), null));
                        Format_17.this.startActivity(intent);
                        dialog.dismiss();
                        return;
                    }
                    Format_17.this.requestPermissions(new String[]{"android.permission.WRITE_EXTERNAL_STORAGE"}, 151);
                    dialog.dismiss();
                }
            });
            dialog.show();
    ...
    public void openDialog(boolean z) {
        new AmbilWarnaDialog(this, this.color, z, new AmbilWarnaDialog.OnAmbilWarnaListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_17.AnonymousClass8 */

            @Override // nithra.resume.maker.cv.builder.app.color.AmbilWarnaDialog.OnAmbilWarnaListener
            public void onOk(AmbilWarnaDialog ambilWarnaDialog, int i) {
                Toast.makeText(Format_17.this, "ok", 0).show();
                Format_17 format_17 = Format_17.this;
                format_17.color = i;
                format_17.displayColor();
                if (Format_17.this.color_dialog.isShowing()) {
                    Format_17.this.color_dialog.dismiss();
                }
            }

            @Override // nithra.resume.maker.cv.builder.app.color.AmbilWarnaDialog.OnAmbilWarnaListener
            public void onCancel(AmbilWarnaDialog ambilWarnaDialog) {
                Toast.makeText(Format_17.this, "cancel", 0).show();
            }
        }).show();
    }
    ...
    public void onResume() {
        ...
        if (new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM).getPath() + "/Nithra/ResumeBuilder/" + this.sp.getString(this, "profile_name") + "_Spick and Span Resume.pdf").exists()) {
