...
public class Format_15 extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        ((AppCompatTextView) findViewById(R.id.title_name)).setText("Smart Resume");
        ...
        this.mWebView.setOnLongClickListener(new View.OnLongClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_15.AnonymousClass1 */
        ...
        this.save.setOnClickListener(new View.OnClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_15.AnonymousClass2 */

            public void onClick(View view) {
                if (Format_15.this.sp.getInt(Format_15.this, "permissiond") == 1) {
                    try {
                    ...
                    Format_15.this.createPdfFile();
                    Format_15.this.wait_dialog.show();
                    return;
                }
                Format_15.this.PermissionFun();
            }
        });
        this.picker.setOnClickListener(new View.OnClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_15.AnonymousClass3 */

            public void onClick(View view) {
                if (Format_15.this.sp.getInt(Format_15.this, "key") == 0) {
                    Format_15.this.sp.putString(Format_15.this, "type", "text");
                    Format_15.this.openDialog(false);
                } else if (Format_15.this.sp.getInt(Format_15.this, "key") == 1) {
                    Format_15.this.color_dialog.show();
                } else if (Format_15.this.sp.getInt(Format_15.this, "key") == 2) {
                    Format_15.this.color_dialog.show();
                } else if (Format_15.this.sp.getInt(Format_15.this, "key") == 3) {
                    Format_15.this.sp.putString(Format_15.this, "type", "text");
                    Format_15.this.openDialog(false);
                } else if (Format_15.this.sp.getInt(Format_15.this, "key") == 4) {
                    Format_15.this.sp.putString(Format_15.this, "type", "text");
                    Format_15.this.openDialog(false);
                } else if (Format_15.this.sp.getInt(Format_15.this, "key") == 5) {
                    Format_15.this.sp.putString(Format_15.this, "type", "text");
                    Format_15.this.openDialog(false);
                } else if (Format_15.this.sp.getInt(Format_15.this, "key") == 6) {
                    Format_15.this.sp.putString(Format_15.this, "type", "text");
                    Format_15.this.openDialog(false);
                } else if (Format_15.this.sp.getInt(Format_15.this, "key") == 7) {
                    Format_15.this.sp.putString(Format_15.this, "type", "text");
                    Format_15.this.openDialog(false);
                } else if (Format_15.this.sp.getInt(Format_15.this, "key") == 8) {
                    Format_15.this.sp.putString(Format_15.this, "type", "text");
                    Format_15.this.openDialog(false);
                }
            }
        ...
        ((LinearLayout) this.color_dialog.findViewById(R.id.text_lay)).setOnClickListener(new View.OnClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_15.AnonymousClass4 */
        ...
        ((LinearLayout) this.color_dialog.findViewById(R.id.border_lay)).setOnClickListener(new View.OnClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_15.AnonymousClass5 */

            public void onClick(View view) {
                Format_15.this.sp.putString(Format_15.this, "type", "bg");
                Format_15.this.openDialog(false);
            }
        });
    ...
    private void first_load() {
        ...
        if (rawQuery.getCount() > 0) {
            ...
            if (string15.equals("") || string15.equals("null")) {
                this.image = " <div class='w3-quarter t3-profile1 w3-padding'>     <img class='t3-profile-image' src='" + "man.png" + "' id='image' alt='Avatar'></div>";
            } else if (this.sp.getBoolean(this, "photo_check").booleanValue()) {
                this.image = " <div class='w3-quarter t3-profile1 w3-padding'>     <img class='t3-profile-image' src='" + string15 + "' id='image' alt='Avatar'></div>";
            } else {
                this.image = " <div class='w3-quarter t3-profile1 w3-padding'>     <img class='t3-profile-image' src='" + "man.png" + "' id='image' alt='Avatar'></div>";
            }
        ...
        if (rawQuery2.getCount() > 0) {
            ...
            if (rawQuery4.getCount() > 0) {
                ...
                this.info = "  <div class='w3-half'>      <h5 class='t7-block_background w3-two w3-padding w3-center w3-padding-tinysmall'>" + this.title + "</h5>      <div class='w3-container w3-two'>" + this.pro_table + "      </div>  </div>";
            }
            rawQuery4.close();
            String str4 = "<table><tr>" + str + str2 + "</tr>" + str3 + "</table>";
            this.personal = "<div class='w3-half'>      <h5 class='t7-block_background w3-two w3-padding w3-center w3-padding-tinysmall'>Contact Info</h5>      <div class='w3-container w3-two'>          <p><i class='fa fa-envelope fa-fw  w3-large'></i> " + this.email + "</p>          <p><i class='fa fa-phone fa-fw  w3-large'></i> " + this.phoneno + "</p>          <p><i class='fa fa-map-marker fa-fw  w3-large'></i> " + this.address.replaceAll("<p dir=\"ltr\">", "").replaceAll("</p>", "").replaceAll("<br>", "") + "</p>      </div>  </div>";
        }
        rawQuery2.close();
        ...
        this.name = "<div class='w3-half'><h2 class='w3-upper-case t3-profile-name w3-margin-bottom-0 w3-mrg-top-12'>" + this.name + "</h2>                    </div> ";
        ...
        if (rawQuery6.getCount() > 0) {
            ...
            if (!string20.equals("")) {
                this.objective = "<div class='w3-half'>       <h5  class='t7-block_background w3-two w3-padding w3-center w3-padding-tinysmall'>Objective</h5>       <div  class='w3-container w3-two'>           <p>" + string20 + "</p>       </div>   </div>";
            }
            if (!string21.equals("")) {
                this.declar = "<div class='w3-half'>    <h5 class='t7-block_background w3-two w3-padding w3-center w3-padding-tinysmall'>Declaration</h5>    <div class='w3-container w3-two'>        <h6>" + string21 + "</h6>    </div></div>";
            }
        }
        ...
        if (rawQuery7.getCount() > 0) {
            ...
            this.experience = "<div class='w3-half'>        <h5 class='t7-block_background w3-two w3-padding w3-center w3-padding-tinysmall'>" + str5 + "</h5>        <div class='w3-container w3-two'>" + this.sub_exp + "        </div>    </div>";
        } else {
        ...
        if (rawQuery10.getCount() > 0) {
            ...
            for (int i5 = 0; i5 < rawQuery10.getCount(); i5++) {
                ...
                rawQuery12.close();
                this.sub_work += "<h6 class='w3-margin-bottom-2'><b>" + string27 + "</b></h6>          <p class='w3-margin-top-0 w3-margin-bottom-0'><b>Description : </b>" + string28 + "</p>          <p class='w3-margin-top-0 w3-margin-bottom-0'><b>Duration : </b>" + string29 + " &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; " + str8 + "          <p class='w3-margin-top-0 w3-margin-bottom-0'><b>Role : </b>" + string30 + "</p>" + string32 + str9;
                rawQuery10.moveToNext();
            }
            this.project = "<div class='w3-half'>      <h5 class='t7-block_background w3-two w3-padding w3-center w3-padding-tinysmall'>" + str7 + "</h5>      <div class='w3-container w3-two'>" + this.sub_work + "      </div>  </div>";
        }
        rawQuery10.close();
        ...
        if (rawQuery13.getCount() > 0) {
            ...
            for (int i8 = 0; i8 < rawQuery13.getCount(); i8++) {
                ...
                rawQuery15.close();
                this.sub_edu += "<h6 class='w3-margin-bottom-2'><b>" + string33 + "</b></h6>            <p class='w3-margin-top-0 w3-margin-bottom-0'>" + string34 + ", <b>" + string35 + "</b>,<b> " + string36 + "</b></p>" + str11;
                rawQuery13.moveToNext();
            }
            this.education = "<div class='w3-half'>     <h5 class='t7-block_background w3-two w3-padding w3-center w3-padding-tinysmall'>" + str10 + "</h5>     <div class='w3-container w3-two'>" + this.sub_edu + "     </div>    </div>";
        }
        rawQuery13.close();
        ...
        if (rawQuery16.getCount() > 0) {
            ...
            this.skill = " <h5 class='t7-block_background w3-two w3-padding w3-center w3-padding-tinysmall'>" + str13 + "</h5> <div class='w3-container w3-two'>" + this.sub_skill + " </div>";
        }
        rawQuery16.close();
        ...
        if (rawQuery18.getCount() > 0) {
            ...
            this.strength = "<div class='w3-half'>      <h5 class='t7-block_background  w3-center w3-two  w3-padding w3-padding-tinysmall'>" + str14 + "</h5>      <div class='w3-container w3-two'>" + this.sub_strength + "      </div>  </div>";
        }
        rawQuery18.close();
        ...
        if (rawQuery20.getCount() > 0) {
            ...
            this.intrest = "<h5 class='t7-block_background w3-two w3-padding w3-center w3-padding-tinysmall'>" + str15 + "</h5>  <div class='w3-container w3-two'>" + this.sub_intrest + "  </div>";
        }
        rawQuery20.close();
        ...
        if (rawQuery24.getCount() > 0 || rawQuery22.getCount() > 0) {
            this.explore = " <div class='w3-half'>     <h5 class='t7-block_background w3-two w3-padding w3-center w3-padding-tinysmall'>Industrial Exposure</h5>     <div class='w3-container w3-two'>" + this.indrust + this.inplant + "     </div> </div>";
        }
        rawQuery24.close();
        rawQuery22.close();
        ...
        if (rawQuery26.getCount() > 0) {
            ...
            this.achive = " <div class='w3-half'>     <h5 class='t7-block_background w3-two w3-padding w3-center w3-padding-tinysmall'>" + str18 + "</h5>     <div class='w3-container w3-two'>                      " + this.sub_achive + "     </div> </div>";
        }
        rawQuery26.close();
        ...
        if (rawQuery30.getCount() > 0 || rawQuery28.getCount() > 0) {
            this.curricular = "<div class='w3-half'>        <h5 class='t7-block_background w3-two w3-padding w3-center w3-padding-tinysmall'>Curricular Activities</h5>        <div class='w3-container w3-two'>" + this.cocuri + this.extra + "        </div>    </div>";
        }
        rawQuery30.close();
        rawQuery28.close();
        ...
        if (rawQuery32.getCount() > 0) {
            ...
            this.hobbi = " <div class='w3-half'>     <h5 class='t7-block_background w3-two w3-padding w3-center w3-padding-tinysmall'>" + str21 + "</h5>     <div class='w3-container w3-two'>" + this.sub_hobbi + "     </div></div>";
        }
        rawQuery32.close();
        ...
        if (rawQuery34.getCount() > 0) {
            ...
            this.reference = "<div class='w3-half'>        <h5 class='t7-block_background w3-two w3-padding w3-center w3-padding-tinysmall'>" + str22 + "</h5>        <div class='w3-container w3-two'>" + this.sub_refer + "        </div>    </div>";
        }
        rawQuery34.close();
    }

    public String resueme() {
        return "<!DOCTYPE html><html>    <title>NithrA - Resume Template 15</title>    <meta charset='UTF-8'>    <link rel='stylesheet' href='css/15.css'>    <link rel='stylesheet' href='css/font-awesome.min.css'>    <style>        @page { size: A4 portrait;margin: 7.5mm 2.5mm 7.5mm 7.5mm;  cover-letter { page-break-after: always;}}            </style>    <body class='w3-templete_background'>        <div class='w3-content' style='max-width:1400px;'>" + this.cover_letter + "            <div class='w3-row w3-container  w3-top-background w3-margin'>                " + this.name + this.image + "            </div>            <div class='w3-row w3-container'>" + this.objective + this.personal + "            </div>            <div class='w3-row w3-container'>" + this.experience + this.education + "            </div>            <div class='w3-row w3-container'>                <div class='w3-half'>" + this.skill + this.intrest + "                </div>" + this.project + "            </div>            <div class='w3-row w3-container'>" + this.achive + this.explore + "            </div>            <div class='w3-row w3-container'>" + this.reference + this.curricular + "            </div>            <div class='w3-row w3-container'>" + this.info + this.strength + "            </div>            <div class='w3-row w3-container'>" + this.declar + this.hobbi + "            </div>            <div class='w3-row'>                <div class='w3-container'>                                <h6>                                    <table>                                        <tr><td width='7%'>Date</td><td width='1%'> : </td><td width='84.5%'>" + this.date + "</td><td>Signature,</td></tr>                                        <tr><td width='7%'>Place</td><td  width='1%'> : </td><td width='80%'>" + this.place + "</td>" + this.sign + "</tr>                                                                           </table>                                </h6>" + this.sign_btm_name + "                     </div>            </div>        </div>    </body></html>";
    }
    ...
    public void createPdfFile() {
        try {
            ...
            new PdfWriter(getApplicationContext(), this.mWebView.createPrintDocumentAdapter(), createEmptyFile).write(new PdfWriter.PdfWriterCallback() {
                /* class nithra.resume.maker.cv.builder.app.Formates.Format_15.AnonymousClass6 */

                @Override // nithra.resume.maker.cv.builder.app.PdfWriter.PdfWriterCallback
                public void onWriteFinished() {
                    Format_15.this.wait_dialog.dismiss();
                    Toast.makeText(Format_15.this.getApplicationContext(), "Resume generated successfully", 0).show();
                    Uri fromFile = Uri.fromFile(new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM) + "/Nithra/ResumeBuilder/" + Format_15.this.fileName));
                    Intent intent = new Intent("android.intent.action.VIEW");
                    intent.setFlags(67108864);
                    intent.setDataAndType(fromFile, "application/pdf");
                    try {
                        Format_15.this.startActivity(intent);
                    } catch (ActivityNotFoundException unused) {
                        Utils.toast_center(Format_15.this, "No Application available to view PDF");
                    }
                }
    ...
    private File createEmptyFile() throws IOException {
        this.fileName = this.sp.getString(this, "profile_name") + "_Smart Resume.pdf";
    ...
    public void PermissionFun() {
        if (Build.VERSION.SDK_INT < 23) {
            ...
            textView.setOnClickListener(new View.OnClickListener() {
                /* class nithra.resume.maker.cv.builder.app.Formates.Format_15.AnonymousClass7 */

                @SuppressLint({"NewApi"})
                public void onClick(View view) {
                    if (Format_15.this.sp.getInt(Format_15.this, "permissiond") == 2) {
                        Intent intent = new Intent();
                        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        intent.setAction("android.settings.APPLICATION_DETAILS_SETTINGS");
                        intent.setData(Uri.fromParts("package", Format_15.this.getPackageName(), null));
                        Format_15.this.startActivity(intent);
                        dialog.dismiss();
                        return;
                    }
                    Format_15.this.requestPermissions(new String[]{"android.permission.WRITE_EXTERNAL_STORAGE"}, 151);
                    dialog.dismiss();
                }
            });
            dialog.show();
    ...
    public void openDialog(boolean z) {
        new AmbilWarnaDialog(this, this.color, z, new AmbilWarnaDialog.OnAmbilWarnaListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_15.AnonymousClass8 */

            @Override // nithra.resume.maker.cv.builder.app.color.AmbilWarnaDialog.OnAmbilWarnaListener
            public void onOk(AmbilWarnaDialog ambilWarnaDialog, int i) {
                Toast.makeText(Format_15.this, "ok", 0).show();
                Format_15 format_15 = Format_15.this;
                format_15.color = i;
                format_15.displayColor();
                if (Format_15.this.color_dialog.isShowing()) {
                    Format_15.this.color_dialog.dismiss();
                }
            }

            @Override // nithra.resume.maker.cv.builder.app.color.AmbilWarnaDialog.OnAmbilWarnaListener
            public void onCancel(AmbilWarnaDialog ambilWarnaDialog) {
                Toast.makeText(Format_15.this, "cancel", 0).show();
            }
        }).show();
    }
    ...
    public void onResume() {
        ...
        if (new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM).getPath() + "/Nithra/ResumeBuilder/" + this.sp.getString(this, "profile_name") + "_Smart Resume.pdf").exists()) {
