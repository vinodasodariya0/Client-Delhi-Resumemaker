...
public class Format_19 extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        ((AppCompatTextView) findViewById(R.id.title_name)).setText("Fresher Resume");
        ...
        this.mWebView.setOnLongClickListener(new View.OnLongClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_19.AnonymousClass1 */
        ...
        this.save.setOnClickListener(new View.OnClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_19.AnonymousClass2 */

            public void onClick(View view) {
                if (Format_19.this.sp.getInt(Format_19.this, "permissiond") == 1) {
                    try {
                    ...
                    Format_19.this.createPdfFile();
                    Format_19.this.wait_dialog.show();
                    return;
                }
                Format_19.this.PermissionFun();
            }
        });
        this.picker.setOnClickListener(new View.OnClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_19.AnonymousClass3 */

            public void onClick(View view) {
                if (Format_19.this.sp.getInt(Format_19.this, "key") == 0) {
                    Format_19.this.sp.putString(Format_19.this, "type", "text");
                    Format_19.this.openDialog(false);
                } else if (Format_19.this.sp.getInt(Format_19.this, "key") == 1) {
                    Format_19.this.color_dialog.show();
                } else if (Format_19.this.sp.getInt(Format_19.this, "key") == 2) {
                    Format_19.this.color_dialog.show();
                } else if (Format_19.this.sp.getInt(Format_19.this, "key") == 3) {
                    Format_19.this.sp.putString(Format_19.this, "type", "text");
                    Format_19.this.openDialog(false);
                } else if (Format_19.this.sp.getInt(Format_19.this, "key") == 4) {
                    Format_19.this.sp.putString(Format_19.this, "type", "text");
                    Format_19.this.openDialog(false);
                } else if (Format_19.this.sp.getInt(Format_19.this, "key") == 5) {
                    Format_19.this.sp.putString(Format_19.this, "type", "text");
                    Format_19.this.openDialog(false);
                } else if (Format_19.this.sp.getInt(Format_19.this, "key") == 6) {
                    Format_19.this.sp.putString(Format_19.this, "type", "text");
                    Format_19.this.openDialog(false);
                } else if (Format_19.this.sp.getInt(Format_19.this, "key") == 7) {
                    Format_19.this.sp.putString(Format_19.this, "type", "text");
                    Format_19.this.openDialog(false);
                } else if (Format_19.this.sp.getInt(Format_19.this, "key") == 8) {
                    Format_19.this.sp.putString(Format_19.this, "type", "text");
                    Format_19.this.openDialog(false);
                }
            }
        ...
        ((LinearLayout) this.color_dialog.findViewById(R.id.text_lay)).setOnClickListener(new View.OnClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_19.AnonymousClass4 */
        ...
        ((LinearLayout) this.color_dialog.findViewById(R.id.border_lay)).setOnClickListener(new View.OnClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_19.AnonymousClass5 */

            public void onClick(View view) {
                Format_19.this.sp.putString(Format_19.this, "type", "bg");
                Format_19.this.openDialog(false);
            }
        });
    ...
    private void first_load() {
        ...
        if (rawQuery.getCount() > 0) {
            ...
            if (string15.equals("") || string15.equals("null")) {
                this.image = "<div class='w3-display-container w3-img-div w3-padding-24 border-left'>    <img class='w3-profile-image' src='" + "man.png" + "' id='image' alt='Avatar'>                        </div>";
            } else if (this.sp.getBoolean(this, "photo_check").booleanValue()) {
                this.image = "<div class='w3-display-container w3-img-div w3-padding-24 border-left'>    <img class='w3-profile-image' src='" + string15 + "' id='image' alt='Avatar'>                        </div>";
            } else {
                this.image = "<div class='w3-display-container w3-img-div w3-padding-24 border-left'>    <img class='w3-profile-image' src='" + "man.png" + "' id='image' alt='Avatar'>                        </div>";
            }
        ...
        if (rawQuery2.getCount() > 0) {
            ...
            if (!this.phoneno.equals("")) {
                str = "<td><i class='fa fa-mobile fa-fw w3-margin-right w3-border'> </i></td><td>" + this.phoneno + "</td>";
            }
            if (!this.email.equals("")) {
                str2 = "<td><i class='fa fa-envelope fa-fw w3-margin-right w3-border'> </i></td><td>" + this.email + "</td>";
            }
            if (!this.address.equals("")) {
                str3 = "<tr><td><i class='fa fa-map-marker fa-fw w3-margin-right w3-border'> </i></td><td colspan=3>" + this.address + "</td></tr>";
            }
            ...
            if (rawQuery4.getCount() > 0) {
                ...
                for (int i = 0; i < rawQuery4.getCount(); i++) {
                    this.pro_table += "<p><b>" + rawQuery4.getString(rawQuery4.getColumnIndex("title")) + " : </b>" + rawQuery4.getString(rawQuery4.getColumnIndex("value")) + "</p>";
                    rawQuery4.moveToNext();
                }
                this.info = "<div class='w3-container w3-white'>        <h2 class='w3-capitalize w3-margin-0 w3-text-templete_color_1'>" + this.title + "</h2>        <div class='w3-container w3-padding-left-20'>" + this.pro_table + "        </div>    </div>";
            }
            rawQuery4.close();
            String str4 = "<table><tr>" + str + str2 + "</tr>" + str3 + "</table>";
            this.personal = "<div class=' w3-container w3-white'>      <h1 class='w3-capitalize w3-margin-bottom-0 w3-text-templete_color_1'><b>" + this.name + "</b></h1>      <div class='w3-container w3-padding-left-20'>                                              <p class='w3-margin-top-0 w3-margin-bottom-0'> " + this.email + "</p>          <p class='w3-margin-top-0 w3-margin-bottom-0'>  " + this.phoneno + "</p>          <p class='w3-margin-top-0 w3-margin-bottom-0'> " + this.address.replaceAll("<p dir=\"ltr\">", "").replaceAll("</p>", "").replaceAll("<br>", "") + "</p>      </div>  </div>";
        }
        rawQuery2.close();
        ...
        if (rawQuery6.getCount() > 0) {
            ...
            if (!string20.equals("")) {
                this.objective = "<div class='w3-container w3-white'>        <h2 class='w3-capitalize w3-margin-0 w3-text-templete_color_1'>Objective</h2>        <div class='w3-container w3-padding-left-20'>            <p class=''>" + string20 + "</p>        </div>    </div>";
            }
            if (!string21.equals("")) {
                this.declar = "<div class='w3-container w3-white'>    <h2 class='w3-capitalize w3-margin-0 w3-text-templete_color_1'>Declaration</h2>    <div class='w3-container w3-padding-left-20'>        <p class=''>" + string21 + "</p>    </div></div>";
            }
        }
        ...
        if (rawQuery7.getCount() > 0) {
            ...
            for (int i2 = 0; i2 < rawQuery7.getCount(); i2++) {
                ...
                rawQuery9.close();
                this.sub_exp += "<h6 class='w3-margin-bottom-0'><b>" + string25 + "</b></h6>             <p class='w3-margin-top-0 w3-margin-bottom-0'><b>Designation : </b><b>" + string24 + ", " + string22 + " - " + string23 + "</b></p>                        " + ((string26.equals("") || string26.equals(null)) ? "" : "<p class='w3-margin-top-0 w3-margin-bottom-0'>Role : " + string26 + "</p>") + str6;
                rawQuery7.moveToNext();
            }
            this.experience = "<div class='w3-container w3-white w3-margin-bottom'>         <h2 class='w3-capitalize w3-margin-0 w3-text-templete_color_1'>" + str5 + "</h2>         <div class='w3-container w3-padding-left-20'>" + this.sub_exp + "         </div>     </div>";
        } else {
        ...
        if (rawQuery10.getCount() > 0) {
            ...
            for (int i5 = 0; i5 < rawQuery10.getCount(); i5++) {
                ...
                rawQuery12.close();
                this.sub_work += "<h6 class='w3-margin-bottom-0'><b>" + string27 + "</b></h6>          <p class='w3-margin-top-0 w3-margin-bottom-0'><b>Description : </b>" + string28 + "</p>          <p class='w3-margin-top-0 w3-margin-bottom-0'><b>Duration : </b>" + string29 + " &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; " + str8 + "          <p class='w3-margin-top-0 w3-margin-bottom-0'><b>Role : </b>" + string30 + "</p>" + string32 + str9;
                rawQuery10.moveToNext();
            }
            this.project = "<div class='w3-container w3-white w3-margin-bottom'>     <h2 class='w3-capitalize w3-margin-0 w3-text-templete_color_1'>" + str7 + "</h2>     <div class='w3-container w3-padding-left-20'>" + this.sub_work + "     </div> </div>";
        }
        rawQuery10.close();
        ...
        if (rawQuery13.getCount() > 0) {
            ...
            for (int i8 = 0; i8 < rawQuery13.getCount(); i8++) {
                ...
                rawQuery15.close();
                this.sub_edu += "<h6 class='w3-margin-bottom-0'><b>" + string33 + "</b></h6>            <p class='w3-margin-top-0 w3-margin-bottom-0'>" + string34 + ", <b>" + string35 + "</b>, <b>" + string36 + "</b></p>" + str11;
                rawQuery13.moveToNext();
            }
            this.education = "<div class='w3-container w3-white w3-margin-bottom'>      <h2 class='w3-capitalize w3-margin-0 w3-text-templete_color_1'>" + str10 + "</h2>      <div class='w3-container w3-padding-left-20'>" + this.sub_edu + "      </div>  </div>";
        }
        rawQuery13.close();
        ...
        if (rawQuery16.getCount() > 0) {
            ...
            this.skill = " <div class='w3-no-break w3-padding-left-20  w3-margin-bottom-0'>     <p class='w3-large w3-capitalize w3-text-templete_color_1 w3-margin-top-0 w3-margin-bottom-0'><b>" + str13 + "</b></p>     <ul class='w3-large w3-padding-left-20 w3-margin-top-0 w3-margin-bottom-0' style='list-style: none;'>" + this.sub_skill + "     </ul>     <br> </div>";
        }
        rawQuery16.close();
        ...
        if (rawQuery18.getCount() > 0) {
            ...
            this.strength = "<div class='w3-container w3-white w3-margin-bottom'>       <h2 class='w3-capitalize w3-margin-0 w3-text-templete_color_1'>" + str14 + "</h2>       <div class='w3-container w3-padding-left-20'>" + this.sub_strength + "       </div>   </div>";
        }
        rawQuery18.close();
        ...
        if (rawQuery20.getCount() > 0) {
            ...
            this.intrest = "<div class='w3-padding-left-20 w3-margin-top-0 w3-margin-bottom-0'>      <p class='w3-large w3-capitalize w3-text-templete_color_1 w3-margin-top-0 w3-margin-bottom-0'><b>" + str15 + "</b></p>      <ul class='w3-large w3-padding-left-20 w3-margin-top-0 w3-margin-bottom-0'' style='list-style: none;'>" + this.sub_intrest + "      </ul>      <br>  </div>";
        }
        rawQuery20.close();
        ...
        if (rawQuery22.getCount() > 0) {
            ...
            for (int i14 = 0; i14 < rawQuery22.getCount(); i14++) {
                this.sub_indust += "<h6>" + rawQuery22.getString(rawQuery22.getColumnIndex("industrial")) + "</h6>";
        ...
        if (rawQuery24.getCount() > 0) {
            ...
            for (int i15 = 0; i15 < rawQuery24.getCount(); i15++) {
                this.sub_inplant += "<h6>" + rawQuery24.getString(rawQuery24.getColumnIndex("inplant")) + "</h6>";
                rawQuery24.moveToNext();
            }
            this.inplant = "  <h5><b>" + str17 + " : </b></h5>" + this.sub_inplant;
        }
        if (rawQuery24.getCount() > 0 || rawQuery22.getCount() > 0) {
            this.explore = "<div class='w3-container w3-white w3-margin-bottom'>      <h2 class='w3-capitalize w3-margin-0 w3-text-templete_color_1'>Industrial Exposure</h2>                                      <div class='w3-container '>     " + this.indrust + this.inplant + "      </div>  </div>";
        }
        rawQuery24.close();
        rawQuery22.close();
        ...
        if (rawQuery26.getCount() > 0) {
            ...
            for (int i16 = 0; i16 < rawQuery26.getCount(); i16++) {
                this.sub_achive += "<h6>" + rawQuery26.getString(rawQuery26.getColumnIndex("achieve")) + "</h6>";
                rawQuery26.moveToNext();
            }
            this.achive = "<div class='w3-container w3-white w3-margin-bottom'>    <h2 class='w3-capitalize w3-margin-0 w3-text-templete_color_1'>" + str18 + "</h2>    <div class='w3-container w3-padding-left-20'>" + this.sub_achive + "    </div></div>";
        }
        rawQuery26.close();
        ...
        if (rawQuery28.getCount() > 0) {
            ...
            for (int i17 = 0; i17 < rawQuery28.getCount(); i17++) {
                this.sub_cocuri += "<h6 class='w3-padding-left-20 font-weight-500'>" + rawQuery28.getString(rawQuery28.getColumnIndex("cocurricular")) + "</h6>";
        ...
        if (rawQuery30.getCount() > 0) {
            ...
            for (int i18 = 0; i18 < rawQuery30.getCount(); i18++) {
                this.sub_extra += "<h6 class='w3-padding-left-20 font-weight-500'>" + rawQuery30.getString(rawQuery30.getColumnIndex("extracurricular")) + "</h6>";
                rawQuery30.moveToNext();
            }
            this.extra = " <h5><b>" + str20 + " : </b></h5>" + this.sub_extra;
        }
        if (rawQuery30.getCount() > 0 || rawQuery28.getCount() > 0) {
            this.curricular = "<div class='w3-container w3-white w3-margin-bottom'>       <h2 class='w3-capitalize w3-margin-0 w3-text-templete_color_1'>Curricular Activities</h2>       <div class=''>" + this.cocuri + this.extra + "       </div>   </div>";
        }
        rawQuery30.close();
        rawQuery28.close();
        Log.e("kozhi55", this.extra);
        ...
        if (rawQuery32.getCount() > 0) {
            ...
            this.hobbi = "<div class='w3-container w3-white w3-margin-bottom'>    <h2 class='w3-capitalize w3-margin-0 w3-text-templete_color_1'>" + str21 + "</h2>    <div class='w3-container w3-padding-left-20'>" + this.sub_hobbi + "    </div></div>";
        }
        rawQuery32.close();
        ...
        if (rawQuery34.getCount() > 0) {
            ...
            for (int i20 = 0; i20 < rawQuery34.getCount(); i20++) {
                ...
                if (rawQuery36.getCount() > 0) {
                    ...
                    for (int i22 = 0; i22 < rawQuery36.getCount(); i22++) {
                        str24 = str24 + "<p class='w3-margin-top-0 w3-margin-bottom-0'>" + rawQuery36.getString(rawQuery36.getColumnIndex("title")) + " : " + rawQuery36.getString(rawQuery36.getColumnIndex("value")) + "</p>";
            ...
            this.reference = "<div class='w3-container w3-white w3-margin-bottom'>       <h2 class='w3-capitalize w3-margin-0 w3-text-templete_color_1'>" + str22 + "</h2>       <div class='w3-container w3-padding-left-20'>" + this.sub_refer + "       </div>   </div>";
        }
        rawQuery34.close();
    }

    public String resueme() {
        return "<!DOCTYPE html><html>    <title>NithrA - Resume Template 19</title>    <meta charset='UTF-8'>    <link rel='stylesheet' href='css/19.css'>    <link rel='stylesheet' href='css/font-awesome.min.css'>    <style>        @page { size: A4 portrait;margin: 5mm;}        html,body,h1,h2,h3,h4,h5,h6 {font-family: 'Arial', sans-serif}    </style>    <body class=''>        <div class='w3-content' style='max-width:1400px;'>" + this.cover_letter + "            <div class='w3-row w3-padding w3-templete_color_1'>                <div class='w3-twothird w3-templete_color_1 border1-right'>                    <div class='main-content w3-white border2-right'>                        <div class='border3-right'>" + this.personal + this.objective + this.education + this.experience + this.project + this.explore + this.achive + this.curricular + this.strength + this.hobbi + this.info + this.reference + this.declar + "                        </div>                    </div>                </div>            </div>        </div>        <div class='w3-row'>            <div class='w3-container'>                                <h6>                                    <table>                                        <tr><td width='7%'>Date</td><td width='1%'> : </td><td width='84.5%'>" + this.date + "</td><td>Signature,</td></tr>                                        <tr><td width='7%'>Place</td><td  width='1%'> : </td><td width='80%'>" + this.place + "</td>" + this.sign + "</tr>                                                                           </table>                                </h6>" + this.sign_btm_name + "                 </div>        </div>    </body></html>";
    }
    ...
    public void createPdfFile() {
        try {
            ...
            new PdfWriter(getApplicationContext(), this.mWebView.createPrintDocumentAdapter(), createEmptyFile).write(new PdfWriter.PdfWriterCallback() {
                /* class nithra.resume.maker.cv.builder.app.Formates.Format_19.AnonymousClass6 */

                @Override // nithra.resume.maker.cv.builder.app.PdfWriter.PdfWriterCallback
                public void onWriteFinished() {
                    Format_19.this.wait_dialog.dismiss();
                    Toast.makeText(Format_19.this.getApplicationContext(), "Resume generated successfully", 0).show();
                    Uri fromFile = Uri.fromFile(new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM) + "/Nithra/ResumeBuilder/" + Format_19.this.fileName));
                    Intent intent = new Intent("android.intent.action.VIEW");
                    intent.setFlags(67108864);
                    intent.setDataAndType(fromFile, "application/pdf");
                    try {
                        Format_19.this.startActivity(intent);
                    } catch (ActivityNotFoundException unused) {
                        Utils.toast_center(Format_19.this, "No Application available to view PDF");
                    }
                }
    ...
    private File createEmptyFile() throws IOException {
        this.fileName = this.sp.getString(this, "profile_name") + "_Fresher Resume.pdf";
    ...
    public void PermissionFun() {
        if (Build.VERSION.SDK_INT < 23) {
            ...
            textView.setOnClickListener(new View.OnClickListener() {
                /* class nithra.resume.maker.cv.builder.app.Formates.Format_19.AnonymousClass7 */

                @SuppressLint({"NewApi"})
                public void onClick(View view) {
                    if (Format_19.this.sp.getInt(Format_19.this, "permissiond") == 2) {
                        Intent intent = new Intent();
                        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        intent.setAction("android.settings.APPLICATION_DETAILS_SETTINGS");
                        intent.setData(Uri.fromParts("package", Format_19.this.getPackageName(), null));
                        Format_19.this.startActivity(intent);
                        dialog.dismiss();
                        return;
                    }
                    Format_19.this.requestPermissions(new String[]{"android.permission.WRITE_EXTERNAL_STORAGE"}, 151);
                    dialog.dismiss();
                }
            });
            dialog.show();
    ...
    public void openDialog(boolean z) {
        new AmbilWarnaDialog(this, this.color, z, new AmbilWarnaDialog.OnAmbilWarnaListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_19.AnonymousClass8 */

            @Override // nithra.resume.maker.cv.builder.app.color.AmbilWarnaDialog.OnAmbilWarnaListener
            public void onOk(AmbilWarnaDialog ambilWarnaDialog, int i) {
                Toast.makeText(Format_19.this, "ok", 0).show();
                Format_19 format_19 = Format_19.this;
                format_19.color = i;
                format_19.displayColor();
                if (Format_19.this.color_dialog.isShowing()) {
                    Format_19.this.color_dialog.dismiss();
                }
            }

            @Override // nithra.resume.maker.cv.builder.app.color.AmbilWarnaDialog.OnAmbilWarnaListener
            public void onCancel(AmbilWarnaDialog ambilWarnaDialog) {
                Toast.makeText(Format_19.this, "cancel", 0).show();
            }
        }).show();
    }
    ...
    public void onResume() {
        ...
        if (new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM).getPath() + "/Nithra/ResumeBuilder/" + this.sp.getString(this, "profile_name") + "_Fresher Resume.pdf").exists()) {
