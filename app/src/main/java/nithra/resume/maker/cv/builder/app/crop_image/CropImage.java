...
public final class CropImage {
    ...
    public static Intent getPickImageChooserIntent(@NonNull Context context, CharSequence charSequence, boolean z, boolean z2) {
        ...
        List<Intent> galleryIntents = getGalleryIntents(packageManager, "android.intent.action.PICK", z);
    ...
    public static List<Intent> getGalleryIntents(@NonNull PackageManager packageManager, String str, boolean z) {
        ArrayList arrayList = new ArrayList();
        Intent intent = str == "android.intent.action.PICK" ? new Intent(str) : new Intent(str, MediaStore.Images.Media.EXTERNAL_CONTENT_URI);
    ...
    public static Uri getCaptureImageOutputUri(@NonNull Context context) {
        File externalCacheDir = context.getExternalFilesDir(Environment.DIRECTORY_DCIM);
        if (externalCacheDir != null) {

            return FileProvider.getUriForFile(context,context.getString(R.string.autority),new File(externalCacheDir.getPath(), "pickImageResult.jpeg"));
    ...
    public static final class ActivityResult extends CropImageView.CropResult implements Parcelable {
        public static final Creator<ActivityResult> CREATOR = new Creator<ActivityResult>() {
            /* class nithra.resume.maker.cv.builder.app.crop_image.CropImage.ActivityResult.AnonymousClass1 */
