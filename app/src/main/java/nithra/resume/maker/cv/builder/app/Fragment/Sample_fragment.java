...
public class Sample_fragment extends Fragment implements Visible {
    ...
    public View onCreateView(LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        context = getActivity();
        return layoutInflater.inflate(R.layout.sample, viewGroup, false);
    }
    ...
    public void exti_result_dialog() {
        ...
        ((TextView) dialog.findViewById(R.id.yes)).setOnClickListener(new View.OnClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Fragment.Sample_fragment.AnonymousClass1 */

            public void onClick(View view) {
                Sample_fragment.context.finish();
                dialog.dismiss();
            }
        });
        ((TextView) dialog.findViewById(R.id.no)).setOnClickListener(new View.OnClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Fragment.Sample_fragment.AnonymousClass2 */
    ...
    public void searchFolderRecursive1(File file) {
        if (!(file == null || file.listFiles() == null)) {
            ...
            Arrays.sort(listFiles, new Comparator<File>() {
                /* class nithra.resume.maker.cv.builder.app.Fragment.Sample_fragment.AnonymousClass3 */
