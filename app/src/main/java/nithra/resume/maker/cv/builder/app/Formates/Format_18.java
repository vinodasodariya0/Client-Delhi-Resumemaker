...
public class Format_18 extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        ((AppCompatTextView) findViewById(R.id.title_name)).setText("Modish Resume");
        ...
        this.mWebView.setOnLongClickListener(new View.OnLongClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_18.AnonymousClass1 */
        ...
        this.save.setOnClickListener(new View.OnClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_18.AnonymousClass2 */

            public void onClick(View view) {
                if (Format_18.this.sp.getInt(Format_18.this, "permissiond") == 1) {
                    try {
                    ...
                    Format_18.this.createPdfFile();
                    Format_18.this.wait_dialog.show();
                    return;
                }
                Format_18.this.PermissionFun();
            }
        });
        this.picker.setOnClickListener(new View.OnClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_18.AnonymousClass3 */

            public void onClick(View view) {
                if (Format_18.this.sp.getInt(Format_18.this, "key") == 0) {
                    Format_18.this.sp.putString(Format_18.this, "type", "text");
                    Format_18.this.openDialog(false);
                } else if (Format_18.this.sp.getInt(Format_18.this, "key") == 1) {
                    Format_18.this.color_dialog.show();
                } else if (Format_18.this.sp.getInt(Format_18.this, "key") == 2) {
                    Format_18.this.color_dialog.show();
                } else if (Format_18.this.sp.getInt(Format_18.this, "key") == 3) {
                    Format_18.this.sp.putString(Format_18.this, "type", "text");
                    Format_18.this.openDialog(false);
                } else if (Format_18.this.sp.getInt(Format_18.this, "key") == 4) {
                    Format_18.this.sp.putString(Format_18.this, "type", "text");
                    Format_18.this.openDialog(false);
                } else if (Format_18.this.sp.getInt(Format_18.this, "key") == 5) {
                    Format_18.this.sp.putString(Format_18.this, "type", "text");
                    Format_18.this.openDialog(false);
                } else if (Format_18.this.sp.getInt(Format_18.this, "key") == 6) {
                    Format_18.this.sp.putString(Format_18.this, "type", "text");
                    Format_18.this.openDialog(false);
                } else if (Format_18.this.sp.getInt(Format_18.this, "key") == 7) {
                    Format_18.this.sp.putString(Format_18.this, "type", "text");
                    Format_18.this.openDialog(false);
                } else if (Format_18.this.sp.getInt(Format_18.this, "key") == 8) {
                    Format_18.this.sp.putString(Format_18.this, "type", "text");
                    Format_18.this.openDialog(false);
                }
            }
        ...
        ((LinearLayout) this.color_dialog.findViewById(R.id.text_lay)).setOnClickListener(new View.OnClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_18.AnonymousClass4 */
        ...
        ((LinearLayout) this.color_dialog.findViewById(R.id.border_lay)).setOnClickListener(new View.OnClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_18.AnonymousClass5 */

            public void onClick(View view) {
                Format_18.this.sp.putString(Format_18.this, "type", "bg");
                Format_18.this.openDialog(false);
            }
        });
    ...
    private void first_load() {
        ...
        if (rawQuery2.getCount() > 0) {
            ...
            if (rawQuery4.getCount() > 0) {
                ...
                this.info = "<div class='w3-container w3-white'>       <h2 class='w3-capitalize w3-margin-bottom-0 w3-text-templete_color_1'>" + this.title + "</h2>       <div class='w3-container w3-padding-left-20'>" + this.pro_table + "       </div>   </div>";
            }
            rawQuery4.close();
            String str4 = "<table><tr>" + str + str2 + "</tr>" + str3 + "</table>";
            this.personal = "<div class=' w3-container w3-white'>       <div class='w3-container w3-padding-left-20'>           <p class='w3-margin-bottom-0'> " + this.email + "</p>           <p class='w3-margin-top-0 w3-margin-bottom-0'>  " + this.phoneno + "</p>           <p class='w3-margin-top-0 w3-margin-bottom-0'> " + this.address.replaceAll("<p dir=\"ltr\">", "").replaceAll("</p>", "").replaceAll("<br>", "") + "</p>       </div>   </div>";
        }
        rawQuery2.close();
        ...
        if (rawQuery6.getCount() > 0) {
            ...
            if (!string20.equals("")) {
                this.objective = "<div class='w3-container w3-white'>       <h2 class='w3-capitalize w3-margin-bottom-0 w3-text-templete_color_1'>Objective</h2>       <div class='w3-container w3-padding-left-20'>           <p class=''>" + string20 + "</p>       </div>   </div>";
            }
            if (!string21.equals("")) {
                this.declar = "<h2 class='w3-capitalize w3-margin-bottom-0 w3-text-templete_color_1' > Declaration </h2 >  <div class='w3-container w3-padding-left-20'>     <p class=''>" + string21 + "</p> </div>";
            }
        }
        ...
        if (rawQuery7.getCount() > 0) {
            ...
            this.experience = "<div class='w3-container w3-white w3-margin-bottom'>        <h2 class='w3-capitalize w3-margin-bottom-0 w3-text-templete_color_1'>" + str5 + "</h2>        <div class='w3-container w3-padding-left-20'>" + this.sub_exp + "        </div>    </div>";
        } else {
        ...
        if (rawQuery10.getCount() > 0) {
            ...
            this.project = " <div class='w3-container w3-white w3-margin-bottom'>     <h2 class='w3-capitalize w3-margin-bottom-0 w3-text-templete_color_1'>" + str7 + "</h2>     <div class='w3-container w3-padding-left-20'>" + this.sub_work + "     </div>                                                                          </div>";
        }
        rawQuery10.close();
        ...
        if (rawQuery13.getCount() > 0) {
            ...
            this.education = "<div class='w3-container w3-white w3-margin-bottom'>        <h2 class='w3-capitalize w3-margin-bottom-0 w3-text-templete_color_1'>" + str10 + "</h2>        <div class='w3-container w3-padding-left-20'>" + this.sub_edu + "        </div>    </div>";
        }
        rawQuery13.close();
        ...
        if (rawQuery16.getCount() > 0) {
            ...
            this.skill = "<div class='w3-no-break w3-padding-left-20'>    <p class='w3-large w3-capitalize orange'><b>" + str13 + "</b></p>    <ul class='w3-large w3-padding-left-20' style='list-style: none;'>" + this.sub_skill + "    </ul>    <br></div>";
        }
        rawQuery16.close();
        ...
        if (rawQuery18.getCount() > 0) {
            ...
            this.strength = "<div class='w3-container w3-white w3-margin-bottom'>      <h2 class='w3-capitalize w3-margin-bottom-0 w3-text-templete_color_1'>" + str14 + "</h2>      <div class='w3-container w3-padding-left-20'>" + this.sub_strength + "      </div>  </div>";
        }
        rawQuery18.close();
        ...
        if (rawQuery20.getCount() > 0) {
            ...
            this.intrest = "<div class='w3-padding-left-20'>     <p class='w3-large w3-capitalize orange w3-margin-top-0'><b>" + str15 + "</b></p>     <ul class='w3-large w3-padding-left-20' style='list-style: none;'>" + this.sub_intrest + "     </ul>     <br> </div>";
        }
        rawQuery20.close();
        ...
        if (rawQuery24.getCount() > 0 || rawQuery22.getCount() > 0) {
            this.explore = " <div class='w3-container w3-white w3-margin-bottom'>     <h2 class='w3-capitalize w3-margin-bottom-0 w3-text-templete_color_1'>Industrial Exposure</h2>     <div class='w3-container w3-padding-left-20'>" + this.indrust + this.inplant + "     </div> </div>";
        }
        rawQuery24.close();
        rawQuery22.close();
        ...
        if (rawQuery26.getCount() > 0) {
            ...
            this.achive = "<div class='w3-container w3-white w3-margin-bottom'>    <h2 class='w3-capitalize w3-margin-bottom-0 w3-text-templete_color_1'>" + str18 + "</h2>    <div class='w3-container w3-padding-left-20'>" + this.sub_achive + "    </div></div>";
        }
        rawQuery26.close();
        ...
        if (rawQuery30.getCount() > 0 || rawQuery28.getCount() > 0) {
            this.curricular = "<div class='w3-container w3-white w3-margin-bottom'>       <h2 class='w3-capitalize w3-margin-bottom-0 w3-text-templete_color_1'>Curricular Activities</h2>       <div class='w3-container w3-padding-left-20'>" + this.cocuri + this.extra + "       </div>   </div>";
        }
        rawQuery30.close();
        rawQuery28.close();
        ...
        if (rawQuery32.getCount() > 0) {
            ...
            this.hobbi = " <div class='w3-container w3-white w3-margin-bottom'>     <h2 class='w3-capitalize w3-margin-bottom-0 w3-text-templete_color_1'>" + str21 + "</h2>     <div class='w3-container w3-padding-left-20'>" + this.sub_hobbi + "     </div> </div>";
        }
        rawQuery32.close();
        ...
        if (rawQuery34.getCount() > 0) {
            ...
            this.reference = "<div class='w3-container w3-white w3-margin-bottom'>       <h2 class='w3-capitalize w3-margin-bottom-0 w3-text-templete_color_1'>" + str22 + "</h2>       <div class='w3-container w3-padding-left-20'>" + this.sub_refer + "       </div>   </div>";
        }
        rawQuery34.close();
    }

    public String resueme() {
        return "<!DOCTYPE html><html>    <title>NithrA - Resume Template 18</title>    <meta charset='UTF-8'>    <link rel='stylesheet' href='css/18.css'>    <link rel='stylesheet' href='css/font-awesome.min.css'>    <style>        @page { size: A4 portrait;margin: 4.5mm;}        html,body,h1,h2,h3,h4,h5,h6 {font-family: 'twcent', sans-serif}    </style>    <body class=''>        <div class='w3-content' style='max-width:1400px;'>" + this.cover_letter + "            <div class='w3-row w3-padding w3-templete_color_1'>                <div class='w3-third '>                    <div class='w3-display-container w3-img-div w3-padding-24 border-left'>" + this.name + this.image + "                    </div>                    <div class='w3-container w3-txt-div border-left'>                                            " + this.skill + this.intrest + "                    </div><br>                </div>                <div class='w3-twothird w3-templete_color_1'>                    <div class='main-content w3-white'>" + this.personal + this.objective + this.education + this.experience + this.project + this.explore + this.achive + this.curricular + this.strength + this.hobbi + this.info + this.reference + "                        <div class='w3-container w3-white w3-margin-bottom'>" + this.declar + "                    <div class=''>                                <h6>                                    <table>                                        <tr><td width='7%'>Date</td><td width='1%'> : </td><td width='84.5%'>" + this.date + "</td><td>Signature,</td></tr>                                        <tr><td width='7%'>Place</td><td  width='1%'> : </td><td width='80%'>" + this.place + "</td>" + this.sign + "</tr>                                                                           </table>                                </h6>" + this.sign_btm_name + "                         </div>                        </div>                    </div>                </div>            </div>        </div>    </body></html>";
    }
    ...
    public void createPdfFile() {
        try {
            ...
            new PdfWriter(getApplicationContext(), this.mWebView.createPrintDocumentAdapter(), createEmptyFile).write(new PdfWriter.PdfWriterCallback() {
                /* class nithra.resume.maker.cv.builder.app.Formates.Format_18.AnonymousClass6 */

                @Override // nithra.resume.maker.cv.builder.app.PdfWriter.PdfWriterCallback
                public void onWriteFinished() {
                    Format_18.this.wait_dialog.dismiss();
                    Toast.makeText(Format_18.this.getApplicationContext(), "Resume generated successfully", 0).show();
                    Uri fromFile = Uri.fromFile(new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM) + "/Nithra/ResumeBuilder/" + Format_18.this.fileName));
                    Intent intent = new Intent("android.intent.action.VIEW");
                    intent.setFlags(67108864);
                    intent.setDataAndType(fromFile, "application/pdf");
                    try {
                        Format_18.this.startActivity(intent);
                    } catch (ActivityNotFoundException unused) {
                        Utils.toast_center(Format_18.this, "No Application available to view PDF");
                    }
                }
    ...
    private File createEmptyFile() throws IOException {
        this.fileName = this.sp.getString(this, "profile_name") + "_Modish Resume.pdf";
    ...
    public void PermissionFun() {
        if (Build.VERSION.SDK_INT < 23) {
            ...
            textView.setOnClickListener(new View.OnClickListener() {
                /* class nithra.resume.maker.cv.builder.app.Formates.Format_18.AnonymousClass7 */

                @SuppressLint({"NewApi"})
                public void onClick(View view) {
                    if (Format_18.this.sp.getInt(Format_18.this, "permissiond") == 2) {
                        Intent intent = new Intent();
                        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        intent.setAction("android.settings.APPLICATION_DETAILS_SETTINGS");
                        intent.setData(Uri.fromParts("package", Format_18.this.getPackageName(), null));
                        Format_18.this.startActivity(intent);
                        dialog.dismiss();
                        return;
                    }
                    Format_18.this.requestPermissions(new String[]{"android.permission.WRITE_EXTERNAL_STORAGE"}, 151);
                    dialog.dismiss();
                }
            });
            dialog.show();
    ...
    public void openDialog(boolean z) {
        new AmbilWarnaDialog(this, this.color, z, new AmbilWarnaDialog.OnAmbilWarnaListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_18.AnonymousClass8 */

            @Override // nithra.resume.maker.cv.builder.app.color.AmbilWarnaDialog.OnAmbilWarnaListener
            public void onOk(AmbilWarnaDialog ambilWarnaDialog, int i) {
                Toast.makeText(Format_18.this, "ok", 0).show();
                Format_18 format_18 = Format_18.this;
                format_18.color = i;
                format_18.displayColor();
                if (Format_18.this.color_dialog.isShowing()) {
                    Format_18.this.color_dialog.dismiss();
                }
            }

            @Override // nithra.resume.maker.cv.builder.app.color.AmbilWarnaDialog.OnAmbilWarnaListener
            public void onCancel(AmbilWarnaDialog ambilWarnaDialog) {
                Toast.makeText(Format_18.this, "cancel", 0).show();
            }
        }).show();
    }
    ...
    public void onResume() {
        ...
        if (new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM).getPath() + "/Nithra/ResumeBuilder/" + this.sp.getString(this, "profile_name") + "_Modish Resume.pdf").exists()) {
