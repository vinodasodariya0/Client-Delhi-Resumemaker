...
public class Format_12 extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        ((AppCompatTextView) findViewById(R.id.title_name)).setText("Creative Resume");
        ...
        this.mWebView.setOnLongClickListener(new View.OnLongClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_12.AnonymousClass1 */
        ...
        this.save.setOnClickListener(new View.OnClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_12.AnonymousClass2 */

            public void onClick(View view) {
                if (Format_12.this.sp.getInt(Format_12.this, "permissiond") == 1) {
                    try {
                    ...
                    Format_12.this.createPdfFile();
                    Format_12.this.wait_dialog.show();
                    return;
                }
                Format_12.this.PermissionFun();
            }
        });
        this.picker.setOnClickListener(new View.OnClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_12.AnonymousClass3 */

            public void onClick(View view) {
                if (Format_12.this.sp.getInt(Format_12.this, "key") == 0) {
                    Format_12.this.sp.putString(Format_12.this, "type", "text");
                    Format_12.this.openDialog(false);
                } else if (Format_12.this.sp.getInt(Format_12.this, "key") == 1) {
                    Format_12.this.color_dialog.show();
                } else if (Format_12.this.sp.getInt(Format_12.this, "key") == 2) {
                    Format_12.this.color_dialog.show();
                } else if (Format_12.this.sp.getInt(Format_12.this, "key") == 3) {
                    Format_12.this.sp.putString(Format_12.this, "type", "text");
                    Format_12.this.openDialog(false);
                } else if (Format_12.this.sp.getInt(Format_12.this, "key") == 4) {
                    Format_12.this.sp.putString(Format_12.this, "type", "text");
                    Format_12.this.openDialog(false);
                } else if (Format_12.this.sp.getInt(Format_12.this, "key") == 5) {
                    Format_12.this.sp.putString(Format_12.this, "type", "text");
                    Format_12.this.openDialog(false);
                } else if (Format_12.this.sp.getInt(Format_12.this, "key") == 6) {
                    Format_12.this.sp.putString(Format_12.this, "type", "text");
                    Format_12.this.openDialog(false);
                } else if (Format_12.this.sp.getInt(Format_12.this, "key") == 7) {
                    Format_12.this.sp.putString(Format_12.this, "type", "text");
                    Format_12.this.openDialog(false);
                } else if (Format_12.this.sp.getInt(Format_12.this, "key") == 8) {
                    Format_12.this.sp.putString(Format_12.this, "type", "text");
                    Format_12.this.openDialog(false);
                }
            }
        ...
        ((LinearLayout) this.color_dialog.findViewById(R.id.text_lay)).setOnClickListener(new View.OnClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_12.AnonymousClass4 */
        ...
        ((LinearLayout) this.color_dialog.findViewById(R.id.border_lay)).setOnClickListener(new View.OnClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_12.AnonymousClass5 */

            public void onClick(View view) {
                Format_12.this.sp.putString(Format_12.this, "type", "bg");
                Format_12.this.openDialog(false);
            }
        });
    ...
    private void first_load() {
        ...
        if (rawQuery2.getCount() > 0) {
            ...
            if (rawQuery4.getCount() > 0) {
                ...
                this.info = "<div class='w3-no-break w3-row w3-container'>        <h5 class='w3-quarter t4-right t3-headeing-color'><b>" + this.title + "</b></h5>        <div class='w3-threequarter t4-right w3-container'>" + this.pro_table + "        </div>    </div>";
            }
            rawQuery4.close();
        ...
        if (rawQuery6.getCount() > 0) {
            ...
            if (!string20.equals("")) {
                this.objective = "<div class='w3-no-break w3-row w3-container'>        <h5 class='w3-quarter t4-right t3-headeing-color'><b>Objective</b></h5>        <div class='w3-threequarter t4-right w3-container'>            <p>" + string20 + "</p>        </div>    </div>";
            }
            if (!string21.equals("")) {
                this.declar = "<h5 class='w3-quarter t4-right t3-headeing-color'><b>Declaration</b></h5><div class='w3-threequarter t4-right w3-container'>    <h6>" + string21 + "</h6>    <br></div>";
            }
        }
        ...
        if (rawQuery7.getCount() > 0) {
            ...
            this.experience = "<div class='w3-no-break w3-row w3-container'>        <h5 class='w3-quarter t4-right t3-headeing-color'><b>" + str5 + "</b></h5>        <div class='w3-threequarter t4-right w3-container'>" + this.sub_exp + "        </div>    </div>";
        } else {
        ...
        if (rawQuery10.getCount() > 0) {
            ...
            this.project = "<div class='w3-no-break w3-row w3-container'>     <h5 class='w3-quarter t4-right t3-headeing-color'><b>" + str7 + "</b></h5>     <div class='w3-threequarter t4-right w3-container'>" + this.sub_work + "     </div> </div>";
        }
        rawQuery10.close();
        ...
        if (rawQuery13.getCount() > 0) {
            ...
            for (int i8 = 0; i8 < rawQuery13.getCount(); i8++) {
                ...
                rawQuery15.close();
                this.sub_edu += "<h6 class='w3-margin-bottom-2 w3-margin-bottom-0'><b>" + string33 + "</b></h6>            <p class='w3-margin-top-0 w3-margin-bottom-0'>" + string34 + ", <b>" + string35 + "</b>, <b>" + string36 + "</b></p>" + str11;
                rawQuery13.moveToNext();
            }
            this.education = "<div class='w3-no-break w3-row w3-container'>       <h5 class='w3-quarter t4-right t3-headeing-color'><b>" + str10 + "</b></h5>       <div class='w3-threequarter t4-right w3-container'>" + this.sub_edu + "       </div>   </div>";
        }
        rawQuery13.close();
        ...
        if (rawQuery16.getCount() > 0) {
            ...
            this.skill = "  <div class='w3-no-break w3-row w3-container'>     <h5 class='w3-quarter t4-right t3-headeing-color'><b>" + str13 + "</b></h5>     <div class='w3-threequarter t4-right w3-container'>" + this.sub_skill + "     </div> </div>";
        }
        rawQuery16.close();
        ...
        if (rawQuery18.getCount() > 0) {
            ...
            this.strength = "<div class='w3-no-break w3-row w3-container'>       <h5 class='w3-quarter t4-right t3-headeing-color'><b>" + str14 + "</b></h5>       <div class='w3-threequarter t4-right w3-container'>" + this.sub_strength + "       </div>   </div>";
        }
        rawQuery18.close();
        ...
        if (rawQuery20.getCount() > 0) {
            ...
            this.intrest = "<div class='w3-no-break w3-row w3-container'>     <h5 class='w3-quarter t4-right t3-headeing-color'><b>" + str15 + "</b></h5>     <div class='w3-threequarter t4-right w3-container'>" + this.sub_intrest + "     </div> </div>";
        }
        rawQuery20.close();
        ...
        if (rawQuery24.getCount() > 0 || rawQuery22.getCount() > 0) {
            this.explore = "<div class='w3-no-break w3-row w3-container'>      <h5 class='w3-quarter t4-right t3-headeing-color'><b>Industrial Exposure</b></h5>      <div class='w3-threequarter t4-right w3-container'>" + this.indrust + this.inplant + "      </div>  </div>";
        }
        rawQuery24.close();
        rawQuery22.close();
        ...
        if (rawQuery26.getCount() > 0) {
            ...
            this.achive = "<div class='w3-no-break w3-row w3-container'>    <h5 class='w3-quarter t4-right t3-headeing-color'><b>" + str18 + "</b></h5>    <div class='w3-threequarter t4-right w3-container'>" + this.sub_achive + "    </div></div>";
        }
        rawQuery26.close();
        ...
        if (rawQuery30.getCount() > 0 || rawQuery28.getCount() > 0) {
            this.curricular = "<div class='w3-no-break w3-row w3-container'>        <h5 class='w3-quarter t4-right t3-headeing-color'><b>Curricular Activities</b></h5>        <div class='w3-threequarter t4-right w3-container'>" + this.cocuri + this.extra + "        </div>    </div>";
        }
        rawQuery30.close();
        rawQuery28.close();
        ...
        if (rawQuery32.getCount() > 0) {
            ...
            this.hobbi = " <div class='w3-no-break w3-row w3-container'>     <h5 class='w3-quarter t4-right t3-headeing-color'><b>" + str21 + "</b></h5>     <div class='w3-threequarter t4-right w3-container'>" + this.sub_hobbi + "     </div></div>";
        }
        rawQuery32.close();
        ...
        if (rawQuery34.getCount() > 0) {
            ...
            this.reference = "<div class='w3-no-break w3-row w3-container'>    <h5 class='w3-quarter t4-right t3-headeing-color'><b>" + str22 + "</b></h5>    <div class='w3-threequarter t4-right w3-container'>" + this.sub_refer + "    </div></div>";
        }
        rawQuery34.close();
    }

    public String resueme() {
        return "<!DOCTYPE html><html>    <title>NithrA - Resume Template 12</title>    <meta charset='UTF-8'>    <link rel='stylesheet' href='css/12.css'>    <link rel='stylesheet' href='css/font-awesome.min.css'>    <style>        @page { size: A4 portrait;margin: 1mm;cover-letter {page-break-after: always;}}    </style>    <body class='w3-templete_background'>        <div class='w3-content' style='max-width:1400px;'>" + this.cover_letter + "            <div class='w3-row'>                <div class='w3-no-break w3-row w3-container w3-top-background w3-margin-custom'>                " + this.personal + this.image + "           </div>                <div class='w3-triangle-down'></div>" + this.objective + this.education + this.experience + this.project + this.intrest + this.skill + this.explore + this.achive + this.curricular + this.strength + this.hobbi + this.info + this.reference + "                <div class='w3-no-break w3-row w3-container'>" + this.declar + "                    <div class='w3-row'>                                <h6>                                    <table>                                        <tr><td width='7%'>Date</td><td width='1%'> : </td><td width='84.5%'>" + this.date + "</td><td>Signature,</td></tr>                                        <tr><td width='7%'>Place</td><td  width='1%'> : </td><td width='80%'>" + this.place + "</td>" + this.sign + "</tr>                                                                           </table>                                </h6>" + this.sign_btm_name + "                         </div>                </div>            </div>        </div>    </body></html>";
    }
    ...
    public void createPdfFile() {
        try {
            ...
            new PdfWriter(getApplicationContext(), this.mWebView.createPrintDocumentAdapter(), createEmptyFile).write(new PdfWriter.PdfWriterCallback() {
                /* class nithra.resume.maker.cv.builder.app.Formates.Format_12.AnonymousClass6 */

                @Override // nithra.resume.maker.cv.builder.app.PdfWriter.PdfWriterCallback
                public void onWriteFinished() {
                    Format_12.this.wait_dialog.dismiss();
                    Toast.makeText(Format_12.this.getApplicationContext(), "Resume generated successfully", 0).show();
                    Uri fromFile = Uri.fromFile(new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM) + "/Nithra/ResumeBuilder/" + Format_12.this.fileName));
                    Intent intent = new Intent("android.intent.action.VIEW");
                    intent.setFlags(67108864);
                    intent.setDataAndType(fromFile, "application/pdf");
                    try {
                        Format_12.this.startActivity(intent);
                    } catch (ActivityNotFoundException unused) {
                        Utils.toast_center(Format_12.this, "No Application available to view PDF");
                    }
                }
    ...
    private File createEmptyFile() throws IOException {
        this.fileName = this.sp.getString(this, "profile_name") + "_Creative Resume.pdf";
    ...
    public void PermissionFun() {
        if (Build.VERSION.SDK_INT < 23) {
            ...
            textView.setOnClickListener(new View.OnClickListener() {
                /* class nithra.resume.maker.cv.builder.app.Formates.Format_12.AnonymousClass7 */

                @SuppressLint({"NewApi"})
                public void onClick(View view) {
                    if (Format_12.this.sp.getInt(Format_12.this, "permissiond") == 2) {
                        Intent intent = new Intent();
                        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        intent.setAction("android.settings.APPLICATION_DETAILS_SETTINGS");
                        intent.setData(Uri.fromParts("package", Format_12.this.getPackageName(), null));
                        Format_12.this.startActivity(intent);
                        dialog.dismiss();
                        return;
                    }
                    Format_12.this.requestPermissions(new String[]{"android.permission.WRITE_EXTERNAL_STORAGE"}, 151);
                    dialog.dismiss();
                }
            });
            dialog.show();
    ...
    public void openDialog(boolean z) {
        new AmbilWarnaDialog(this, this.color, z, new AmbilWarnaDialog.OnAmbilWarnaListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_12.AnonymousClass8 */

            @Override // nithra.resume.maker.cv.builder.app.color.AmbilWarnaDialog.OnAmbilWarnaListener
            public void onOk(AmbilWarnaDialog ambilWarnaDialog, int i) {
                Toast.makeText(Format_12.this, "ok", 0).show();
                Format_12 format_12 = Format_12.this;
                format_12.color = i;
                format_12.displayColor();
                if (Format_12.this.color_dialog.isShowing()) {
                    Format_12.this.color_dialog.dismiss();
                }
            }

            @Override // nithra.resume.maker.cv.builder.app.color.AmbilWarnaDialog.OnAmbilWarnaListener
            public void onCancel(AmbilWarnaDialog ambilWarnaDialog) {
                Toast.makeText(Format_12.this, "cancel", 0).show();
            }
        }).show();
    }
    ...
    public void onResume() {
        ...
        if (new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM).getPath() + "/Nithra/ResumeBuilder/" + this.sp.getString(this, "profile_name") + "_Creative Resume.pdf").exists()) {
