...
public class Format_20 extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        ((AppCompatTextView) findViewById(R.id.title_name)).setText("Technical Resume");
        ...
        this.mWebView.setOnLongClickListener(new View.OnLongClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_20.AnonymousClass1 */
        ...
        this.save.setOnClickListener(new View.OnClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_20.AnonymousClass2 */

            public void onClick(View view) {
                if (Format_20.this.sp.getInt(Format_20.this, "permissiond") == 1) {
                    try {
                    ...
                    Format_20.this.createPdfFile();
                    Format_20.this.wait_dialog.show();
                    return;
                }
                Format_20.this.PermissionFun();
            }
        });
        this.picker.setOnClickListener(new View.OnClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_20.AnonymousClass3 */

            public void onClick(View view) {
                if (Format_20.this.sp.getInt(Format_20.this, "key") == 0) {
                    Format_20.this.sp.putString(Format_20.this, "type", "text");
                    Format_20.this.openDialog(false);
                } else if (Format_20.this.sp.getInt(Format_20.this, "key") == 1) {
                    Format_20.this.color_dialog.show();
                } else if (Format_20.this.sp.getInt(Format_20.this, "key") == 2) {
                    Format_20.this.color_dialog.show();
                } else if (Format_20.this.sp.getInt(Format_20.this, "key") == 3) {
                    Format_20.this.sp.putString(Format_20.this, "type", "text");
                    Format_20.this.openDialog(false);
                } else if (Format_20.this.sp.getInt(Format_20.this, "key") == 4) {
                    Format_20.this.sp.putString(Format_20.this, "type", "text");
                    Format_20.this.openDialog(false);
                } else if (Format_20.this.sp.getInt(Format_20.this, "key") == 5) {
                    Format_20.this.sp.putString(Format_20.this, "type", "text");
                    Format_20.this.openDialog(false);
                } else if (Format_20.this.sp.getInt(Format_20.this, "key") == 6) {
                    Format_20.this.sp.putString(Format_20.this, "type", "text");
                    Format_20.this.openDialog(false);
                } else if (Format_20.this.sp.getInt(Format_20.this, "key") == 7) {
                    Format_20.this.sp.putString(Format_20.this, "type", "text");
                    Format_20.this.openDialog(false);
                } else if (Format_20.this.sp.getInt(Format_20.this, "key") == 8) {
                    Format_20.this.sp.putString(Format_20.this, "type", "text");
                    Format_20.this.openDialog(false);
                }
            }
        ...
        ((LinearLayout) this.color_dialog.findViewById(R.id.text_lay)).setOnClickListener(new View.OnClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_20.AnonymousClass4 */
        ...
        ((LinearLayout) this.color_dialog.findViewById(R.id.border_lay)).setOnClickListener(new View.OnClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_20.AnonymousClass5 */

            public void onClick(View view) {
                Format_20.this.sp.putString(Format_20.this, "type", "bg");
                Format_20.this.openDialog(false);
            }
        });
    ...
    private void first_load() {
        ...
        if (rawQuery.getCount() > 0) {
            ...
            if (string15.equals("") || string15.equals("null")) {
                this.image = "<img class='t3-profile-image' src='" + "man.png" + "' alt='Avatar'>";
            } else if (this.sp.getBoolean(this, "photo_check").booleanValue()) {
                this.image = "<img class='t3-profile-image' src='" + string15 + "' alt='Avatar'>";
            } else {
                this.image = "<img class='t3-profile-image' src='" + "man.png" + "' alt='Avatar'>";
            }
        ...
        if (rawQuery2.getCount() > 0) {
            ...
            if (rawQuery4.getCount() > 0) {
                ...
                this.info = "<h4 class='w3-two w3-padding  w3-padding-tinysmall'><b>" + this.title + "</b></h4>        <div class='w3-container w3-two'>" + this.pro_table + "</div>";
            }
            rawQuery4.close();
            String str4 = "<table><tr>" + str + str2 + "</tr>" + str3 + "</table>";
            this.personal = "<div class='w3-padding-40'>       <p class=' list-cust'> " + this.email + "</p>       <p class=' list-cust'>" + this.phoneno + "</p>       <p class=' list-cust'> " + this.address.replaceAll("<p dir=\"ltr\">", "").replaceAll("</p>", "").replaceAll("<br>", "") + "</p>   </div>";
        }
        rawQuery2.close();
        ...
        this.name = "<h2 class='w3-upper-case w3-center  t3-profile-name w3-margin-bottom-0'>" + this.name + "</h2>";
        ...
        if (rawQuery6.getCount() > 0) {
            ...
            if (!string20.equals("")) {
                this.objective = "<div class='w3-half'>        <h4  class='w3-two w3-padding  w3-padding-tinysmall'><b>Objective</b></h4>        <div  class='w3-container w3-two'>            <h6>" + string20 + "</h6>        </div>    </div>";
            }
            if (!string21.equals("")) {
                this.declar = " <h4 class='w3-two w3-padding  w3-padding-tinysmall'><b>Declaration</b></h4> <div class='w3-container w3-two'>     <h6>" + string21 + "</h6> </div>";
            }
        }
        ...
        if (rawQuery7.getCount() > 0) {
            ...
            for (int i2 = 0; i2 < rawQuery7.getCount(); i2++) {
                ...
                rawQuery9.close();
                this.sub_exp += "<h6 class='w3-margin-bottom-2'><b>" + string25 + "</b></h6>             <p class='w3-margin-top-0 w3-margin-bottom-0'><b><b>Designation : </b>" + string24 + ", " + string22 + " - " + string23 + "</b></p>                        " + ((string26.equals("") || string26.equals(null)) ? "" : "<p class='w3-margin-top-0 w3-margin-bottom-0'><b>Role : </b>" + string26 + "</p>") + str6;
                rawQuery7.moveToNext();
            }
            this.experience = "<div class='w3-half'>         <h4 class='w3-two w3-padding  w3-padding-tinysmall'><b>" + str5 + "</b></h4>         <div class='w3-container w3-two'>" + this.sub_exp + "         </div>     </div>";
        } else {
        ...
        if (rawQuery10.getCount() > 0) {
            ...
            this.project = "<div class='w3-half'>     <h4 class='w3-two w3-padding  w3-padding-tinysmall'><b>" + str7 + "</b></h4>     <div class='w3-container w3-two'>" + this.sub_work + "     </div> </div>";
        }
        rawQuery10.close();
        ...
        if (rawQuery13.getCount() > 0) {
            ...
            this.education = "<div class='w3-half'>        <h4  class='w3-two w3-padding  w3-padding-tinysmall'><b>" + str10 + "</b></h4>        <div class='w3-container w3-two'>" + this.sub_edu + "        </div>    </div>";
        }
        rawQuery13.close();
        ...
        if (rawQuery16.getCount() > 0) {
            ...
            this.skill = "<div class='w3-half'>    <h4 class='w3-two w3-padding  w3-padding-tinysmall'><b>" + str13 + "</b></h4>    <div class='w3-container w3-two'>" + this.sub_skill + "    </div></div>";
        }
        rawQuery16.close();
        ...
        if (rawQuery18.getCount() > 0) {
            ...
            this.strength = "  <h4 class='w3-two w3-padding-tinysmall'><b>" + str14 + "</b></h4>  <div class='w3-container w3-two'>" + this.sub_strength + "  </div>";
        }
        rawQuery18.close();
        ...
        if (rawQuery20.getCount() > 0) {
            ...
            this.intrest = "<div class='w3-half'>     <h4 class='w3-two w3-padding  w3-padding-tinysmall'><b>" + str15 + "</b></h4>     <div class='w3-container w3-two'>" + this.sub_intrest + "     </div> </div>";
        }
        rawQuery20.close();
        ...
        if (rawQuery24.getCount() > 0 || rawQuery22.getCount() > 0) {
            this.explore = "<div class='w3-half'>     <h4 class='w3-two w3-padding  w3-padding-tinysmall'><b>Industrial Exposure</b></h4>     <div class='w3-container w3-two'>" + this.indrust + this.inplant + "     </div> </div>";
        }
        rawQuery24.close();
        rawQuery22.close();
        ...
        if (rawQuery26.getCount() > 0) {
            ...
            this.achive = "<div class='w3-half'>     <h4 class='w3-two w3-padding  w3-padding-tinysmall'><b>" + str18 + "</b></h4>     <div class='w3-container w3-two'>" + this.sub_achive + "     </div> </div>";
        }
        rawQuery26.close();
        ...
        if (rawQuery30.getCount() > 0 || rawQuery28.getCount() > 0) {
            this.curricular = "<div class='w3-half'>        <h4 class='w3-two w3-padding  w3-padding-tinysmall'><b>Curricular Activities</b></h4>        <div class='w3-container w3-two'>" + this.cocuri + this.extra + "        </div>    </div> ";
        }
        rawQuery30.close();
        rawQuery28.close();
        ...
        if (rawQuery32.getCount() > 0) {
            ...
            this.hobbi = " <h4 class='w3-two w3-padding  w3-padding-tinysmall'><b>" + str21 + "</b></h4> <div class='w3-container w3-two'>" + this.sub_hobbi + " </div>";
        }
        rawQuery32.close();
        ...
        if (rawQuery34.getCount() > 0) {
            ...
            this.reference = "<div class='w3-half'>      <h4 class='w3-two w3-padding w3-padding-tinysmall'><b>" + str22 + "</b></h4>      <div class='w3-container w3-two'>" + this.sub_refer + "      </div>  </div>";
        }
        rawQuery34.close();
    }

    public String resueme() {
        return "<!DOCTYPE html><html>    <title>NithrA - Resume Template 20</title>    <meta charset='UTF-8'>    <link rel='stylesheet' href='css/20.css'>    <link rel='stylesheet' href='css/font-awesome.min.css'>    <style>        @page { size: A4 portrait;margin: 7.5mm 2.5mm 7.5mm 7.5mm;cover-letter {page-break-after: always;}}    </style>    <body class='w3-templete_background'>        <div class='w3-content' style='max-width:1400px;'>" + this.cover_letter + this.name + "            <div class='w3-row  w3-margin'>                                <div class='w3-threequarter w3-padding-top-70 list-background'>                     " + this.personal + "                </div>                                 <div class='w3-quarter w3-padding-20 t3-profile1 img-background'>                    " + this.image + "                </div>                        </div>            <div class='w3-row w3-container'>" + this.education + this.objective + "            </div>            <div class='w3-row w3-container'>                                " + this.project + this.experience + "                </div>                            </div>            <div class='w3-row w3-container'>                                                " + this.explore + this.skill + "            </div>            <div class='w3-row w3-container'>" + this.intrest + this.achive + "            </div>            <div class='w3-row w3-container'>" + this.curricular + "                <div class='w3-half'>" + this.strength + this.hobbi + "                </div>            </div>            <div class='w3-row w3-container'>                                " + this.reference + "                <div class='w3-half'>" + this.info + this.declar + "                </div>                </div>                                    <div class='w3-row'>            <div class='w3-container'>                                <h6>                                    <table>                                        <tr><td width='7%'>Date</td><td width='1%'> : </td><td width='84.5%'>" + this.date + "</td><td>Signature,</td></tr>                                        <tr><td width='7%'>Place</td><td  width='1%'> : </td><td width='80%'>" + this.place + "</td>" + this.sign + "</tr>                                                                           </table>                                </h6>" + this.sign_btm_name + "                 </div>            </div>        </div>    </body></html>";
    }
    ...
    public void createPdfFile() {
        try {
            ...
            new PdfWriter(getApplicationContext(), this.mWebView.createPrintDocumentAdapter(), createEmptyFile).write(new PdfWriter.PdfWriterCallback() {
                /* class nithra.resume.maker.cv.builder.app.Formates.Format_20.AnonymousClass6 */

                @Override // nithra.resume.maker.cv.builder.app.PdfWriter.PdfWriterCallback
                public void onWriteFinished() {
                    Format_20.this.wait_dialog.dismiss();
                    Toast.makeText(Format_20.this.getApplicationContext(), "Resume generated successfully", 0).show();
                    Uri fromFile = Uri.fromFile(new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM) + "/Nithra/ResumeBuilder/" + Format_20.this.fileName));
                    Intent intent = new Intent("android.intent.action.VIEW");
                    intent.setFlags(67108864);
                    intent.setDataAndType(fromFile, "application/pdf");
                    try {
                        Format_20.this.startActivity(intent);
                    } catch (ActivityNotFoundException unused) {
                        Utils.toast_center(Format_20.this, "No Application available to view PDF");
                    }
                }
    ...
    private File createEmptyFile() throws IOException {
        this.fileName = this.sp.getString(this, "profile_name") + "_Technical Resume.pdf";
    ...
    public void PermissionFun() {
        if (Build.VERSION.SDK_INT < 23) {
            ...
            textView.setOnClickListener(new View.OnClickListener() {
                /* class nithra.resume.maker.cv.builder.app.Formates.Format_20.AnonymousClass7 */

                @SuppressLint({"NewApi"})
                public void onClick(View view) {
                    if (Format_20.this.sp.getInt(Format_20.this, "permissiond") == 2) {
                        Intent intent = new Intent();
                        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        intent.setAction("android.settings.APPLICATION_DETAILS_SETTINGS");
                        intent.setData(Uri.fromParts("package", Format_20.this.getPackageName(), null));
                        Format_20.this.startActivity(intent);
                        dialog.dismiss();
                        return;
                    }
                    Format_20.this.requestPermissions(new String[]{"android.permission.WRITE_EXTERNAL_STORAGE"}, 151);
                    dialog.dismiss();
                }
            });
            dialog.show();
    ...
    public void openDialog(boolean z) {
        new AmbilWarnaDialog(this, this.color, z, new AmbilWarnaDialog.OnAmbilWarnaListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_20.AnonymousClass8 */

            @Override // nithra.resume.maker.cv.builder.app.color.AmbilWarnaDialog.OnAmbilWarnaListener
            public void onOk(AmbilWarnaDialog ambilWarnaDialog, int i) {
                Toast.makeText(Format_20.this, "ok", 0).show();
                Format_20 format_20 = Format_20.this;
                format_20.color = i;
                format_20.displayColor();
                if (Format_20.this.color_dialog.isShowing()) {
                    Format_20.this.color_dialog.dismiss();
                }
            }

            @Override // nithra.resume.maker.cv.builder.app.color.AmbilWarnaDialog.OnAmbilWarnaListener
            public void onCancel(AmbilWarnaDialog ambilWarnaDialog) {
                Toast.makeText(Format_20.this, "cancel", 0).show();
            }
        }).show();
    }
    ...
    public void onResume() {
        ...
        if (new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM).getPath() + "/Nithra/ResumeBuilder/" + this.sp.getString(this, "profile_name") + "_Technical Resume.pdf").exists()) {
