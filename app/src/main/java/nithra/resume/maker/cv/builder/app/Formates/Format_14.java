...
public class Format_14 extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        ((AppCompatTextView) findViewById(R.id.title_name)).setText("Basic Resume");
        ...
        this.mWebView.setOnLongClickListener(new View.OnLongClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_14.AnonymousClass1 */
        ...
        this.save.setOnClickListener(new View.OnClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_14.AnonymousClass2 */

            public void onClick(View view) {
                if (Format_14.this.sp.getInt(Format_14.this, "permissiond") == 1) {
                    try {
                    ...
                    Format_14.this.createPdfFile();
                    Format_14.this.wait_dialog.show();
                    return;
                }
                Format_14.this.PermissionFun();
            }
        });
        this.picker.setOnClickListener(new View.OnClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_14.AnonymousClass3 */

            public void onClick(View view) {
                if (Format_14.this.sp.getInt(Format_14.this, "key") == 0) {
                    Format_14.this.sp.putString(Format_14.this, "type", "text");
                    Format_14.this.openDialog(false);
                } else if (Format_14.this.sp.getInt(Format_14.this, "key") == 1) {
                    Format_14.this.color_dialog.show();
                } else if (Format_14.this.sp.getInt(Format_14.this, "key") == 2) {
                    Format_14.this.color_dialog.show();
                } else if (Format_14.this.sp.getInt(Format_14.this, "key") == 3) {
                    Format_14.this.sp.putString(Format_14.this, "type", "text");
                    Format_14.this.openDialog(false);
                } else if (Format_14.this.sp.getInt(Format_14.this, "key") == 4) {
                    Format_14.this.sp.putString(Format_14.this, "type", "text");
                    Format_14.this.openDialog(false);
                } else if (Format_14.this.sp.getInt(Format_14.this, "key") == 5) {
                    Format_14.this.sp.putString(Format_14.this, "type", "text");
                    Format_14.this.openDialog(false);
                } else if (Format_14.this.sp.getInt(Format_14.this, "key") == 6) {
                    Format_14.this.sp.putString(Format_14.this, "type", "text");
                    Format_14.this.openDialog(false);
                } else if (Format_14.this.sp.getInt(Format_14.this, "key") == 7) {
                    Format_14.this.sp.putString(Format_14.this, "type", "text");
                    Format_14.this.openDialog(false);
                } else if (Format_14.this.sp.getInt(Format_14.this, "key") == 8) {
                    Format_14.this.sp.putString(Format_14.this, "type", "text");
                    Format_14.this.openDialog(false);
                }
            }
        ...
        ((LinearLayout) this.color_dialog.findViewById(R.id.text_lay)).setOnClickListener(new View.OnClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_14.AnonymousClass4 */
        ...
        ((LinearLayout) this.color_dialog.findViewById(R.id.border_lay)).setOnClickListener(new View.OnClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_14.AnonymousClass5 */

            public void onClick(View view) {
                Format_14.this.sp.putString(Format_14.this, "type", "bg");
                Format_14.this.openDialog(false);
            }
        });
    ...
    private void first_load() {
        ...
        if (rawQuery2.getCount() > 0) {
            ...
            if (rawQuery4.getCount() > 0) {
                ...
                this.info = "<div class='w3-padding-12 w3-row'>        <h5 class='t7-block_background w3-half-new w3-padding-tinysmall w3-margin-top-small'>" + this.title + "</h5>        <div class='w3-container list'>" + this.pro_table + "        </div>    </div>";
            }
            rawQuery4.close();
            String str4 = "<table><tr>" + str + str2 + "</tr>" + str3 + "</table>";
            this.personal = "<div class='w3-half-new t3-right'>                          <h2 class='w3-upper-case t3-profile-name w3-padding-top w3-padding-bottom w3-margin-bottom-0 t7-block_background'>" + this.name + "</h2>                           <h6 class='t3-profile-address w3-padding-left-20 w3-margin-top-0 w3-margin-bottom-0'>" + this.address.replaceAll("<p dir=\"ltr\">", "").replaceAll("</p>", "").replaceAll("<br>", "") + "</h6>       <h6 class='t3-profile-detail w3-padding-left-20 w3-margin-top-0 w3-margin-bottom-0'> " + this.phoneno + "</h6>       <h6 class='t3-profile-detail w3-padding-left-20 w3-margin-top-0 w3-margin-bottom-0'> " + this.email + "</h6>                      </div>";
        }
        rawQuery2.close();
        if (this.sp.getBoolean(this, "sign_name_check").booleanValue()) {
            this.sign_name = "<tr><td width='92%'></td><td class='w3-center'><h6>(" + this.name + ")</h6></td></tr>";
        ...
        if (rawQuery6.getCount() > 0) {
            ...
            if (!string20.equals("")) {
                this.objective = "<div class='w3-padding-12 w3-row'>        <h5 class='t7-block_background w3-half-new w3-padding-tinysmall w3-margin-top-small'>Objective</h5>        <div class='w3-container list'>            <p>" + string20 + "</p>        </div>    </div>";
            }
            if (!string21.equals("")) {
                this.declar = "<div class='w3-no-break w3-row'>    <h5 class='t7-block_background w3-half-new w3-padding-tinysmall'>Declaration</h5>    <div class='w3-container'>        <h6>" + string21 + "</h6>    </div></div>";
            }
        }
        ...
        if (rawQuery7.getCount() > 0) {
            ...
            this.experience = "<div class='w3-no-break w3-row'>    <h5 class='t7-block_background w3-half-new w3-padding-tinysmall'>" + str5 + "</h5>    <div class='w3-container'>" + this.sub_exp + "    </div></div>";
        } else {
        ...
        if (rawQuery10.getCount() > 0) {
            ...
            this.project = "<div class='w3-no-break w3-row'>     <h5 class='t7-block_background w3-half-new w3-padding-tinysmall'>" + str7 + "</h5>     <div class='w3-container'>" + this.sub_work + "     </div> </div>";
        }
        rawQuery10.close();
        ...
        if (rawQuery13.getCount() > 0) {
            ...
            this.education = "<div class='w3-no-break w3-row'>       <h5 class='t7-block_background w3-half-new w3-padding-tinysmall'>" + str10 + "</h5>       <div class='w3-container'>" + this.sub_edu + "       </div>   </div>";
        }
        rawQuery13.close();
        ...
        if (rawQuery16.getCount() > 0) {
            ...
            this.skill = " <div class='w3-no-break w3-row'>   <h5 class='t7-block_background w3-half-new w3-padding-tinysmall'>" + str13 + "</h5>   <div class='w3-container'>" + this.sub_skill + "   </div> </div>";
        }
        rawQuery16.close();
        ...
        if (rawQuery18.getCount() > 0) {
            ...
            this.strength = "<div class='w3-no-break w3-row'>      <h5 class='t7-block_background w3-half-new w3-padding-tinysmall'>" + str14 + "</h5>      <div class='w3-container'>" + this.sub_strength + "      </div>  </div>";
        }
        rawQuery18.close();
        ...
        if (rawQuery20.getCount() > 0) {
            ...
            this.intrest = "<div class='w3-no-break w3-row'>     <h5 class='t7-block_background w3-half-new w3-padding-tinysmall'>" + str15 + "</h5>     <div class='w3-container'>" + this.sub_intrest + "     </div> </div>";
        }
        rawQuery20.close();
        ...
        if (rawQuery24.getCount() > 0 || rawQuery22.getCount() > 0) {
            this.explore = "<div class='w3-no-break w3-row'>      <h5 class='t7-block_background w3-half-new w3-padding-tinysmall'>Industrial Exposure</h5>      <div class='w3-container'>" + this.indrust + this.inplant + "      </div>  </div>";
        }
        rawQuery24.close();
        rawQuery22.close();
        ...
        if (rawQuery26.getCount() > 0) {
            ...
            this.achive = "<div class='w3-no-break w3-row'>    <h5 class='t7-block_background w3-half-new w3-padding-tinysmall'>" + str18 + "</h5>    <div class='w3-container'>                      " + this.sub_achive + "    </div></div>";
        }
        rawQuery26.close();
        ...
        if (rawQuery30.getCount() > 0 || rawQuery28.getCount() > 0) {
            this.curricular = "<div class='w3-no-break w3-row'>        <h5 class='t7-block_background w3-half-new w3-padding-tinysmall'>Curricular Activities</h5>        <div class='w3-container'>" + this.cocuri + this.extra + "        </div>    </div>";
        }
        rawQuery30.close();
        rawQuery28.close();
        ...
        if (rawQuery32.getCount() > 0) {
            ...
            this.hobbi = "<div class='w3-no-break w3-row'>    <h5 class='t7-block_background w3-half-new w3-padding-tinysmall'>" + str21 + "</h5>    <div class='w3-container'>" + this.sub_hobbi + "    </div></div>";
        }
        rawQuery32.close();
        ...
        if (rawQuery34.getCount() > 0) {
            ...
            this.reference = "<div class='w3-no-break w3-row'>       <h5 class='t7-block_background w3-half-new w3-padding-tinysmall'>" + str22 + "</h5>       <div class='w3-container'>" + this.sub_refer + "       </div>   </div>";
        }
        rawQuery34.close();
    }

    public String resueme() {
        return "<!DOCTYPE html><html>    <title>NithrA - Resume Template 14</title>    <meta charset='UTF-8'>    <link rel='stylesheet' href='css/14.css'>    <link rel='stylesheet' href='css/font-awesome.min.css'>    <style>        @page { size: A4 portrait;margin: 7.5mm 2.5mm 7.5mm 7.5mm;cover-letter {page-break-after: always;}}    </style>    <body class='w3-templete_background'>        <div class='w3-content' style='max-width:1400px;'>" + this.cover_letter + "            <div class='w3-no-break w3-row w3-container w3-margin-top w3-margin-bottom'>" + this.image + this.personal + "            </div>            <div class='w3-row w3-container'>" + this.objective + this.education + this.experience + this.project + this.intrest + this.skill + this.explore + this.achive + this.curricular + this.strength + this.hobbi + this.info + this.reference + this.declar + "                <div class='w3-row'>                    <div class=''>                                <h6>                                    <table>                                        <tr><td width='7%'>Date</td><td width='1%'> : </td><td width='84.5%'>" + this.date + "</td><td>Signature,</td></tr>                                        <tr><td width='7%'>Place</td><td  width='1%'> : </td><td width='80%'>" + this.place + "</td>" + this.sign + "</tr>                                                                           </table>                                </h6>" + this.sign_btm_name + "                         </div>                </div>            </div>        </div>    </body></html>";
    }
    ...
    public void createPdfFile() {
        try {
            ...
            new PdfWriter(getApplicationContext(), this.mWebView.createPrintDocumentAdapter(), createEmptyFile).write(new PdfWriter.PdfWriterCallback() {
                /* class nithra.resume.maker.cv.builder.app.Formates.Format_14.AnonymousClass6 */

                @Override // nithra.resume.maker.cv.builder.app.PdfWriter.PdfWriterCallback
                public void onWriteFinished() {
                    Format_14.this.wait_dialog.dismiss();
                    Toast.makeText(Format_14.this.getApplicationContext(), "Resume generated successfully", 0).show();
                    Uri fromFile = Uri.fromFile(new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM) + "/Nithra/ResumeBuilder/" + Format_14.this.fileName));
                    Intent intent = new Intent("android.intent.action.VIEW");
                    intent.setFlags(67108864);
                    intent.setDataAndType(fromFile, "application/pdf");
                    try {
                        Format_14.this.startActivity(intent);
                    } catch (ActivityNotFoundException unused) {
                        Utils.toast_center(Format_14.this, "No Application available to view PDF");
                    }
                }
    ...
    private File createEmptyFile() throws IOException {
        this.fileName = this.sp.getString(this, "profile_name") + "_Basic Resume.pdf";
    ...
    public void PermissionFun() {
        if (Build.VERSION.SDK_INT < 23) {
            ...
            textView.setOnClickListener(new View.OnClickListener() {
                /* class nithra.resume.maker.cv.builder.app.Formates.Format_14.AnonymousClass7 */

                @SuppressLint({"NewApi"})
                public void onClick(View view) {
                    if (Format_14.this.sp.getInt(Format_14.this, "permissiond") == 2) {
                        Intent intent = new Intent();
                        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        intent.setAction("android.settings.APPLICATION_DETAILS_SETTINGS");
                        intent.setData(Uri.fromParts("package", Format_14.this.getPackageName(), null));
                        Format_14.this.startActivity(intent);
                        dialog.dismiss();
                        return;
                    }
                    Format_14.this.requestPermissions(new String[]{"android.permission.WRITE_EXTERNAL_STORAGE"}, 151);
                    dialog.dismiss();
                }
            });
            dialog.show();
    ...
    public void openDialog(boolean z) {
        new AmbilWarnaDialog(this, this.color, z, new AmbilWarnaDialog.OnAmbilWarnaListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_14.AnonymousClass8 */

            @Override // nithra.resume.maker.cv.builder.app.color.AmbilWarnaDialog.OnAmbilWarnaListener
            public void onOk(AmbilWarnaDialog ambilWarnaDialog, int i) {
                Toast.makeText(Format_14.this, "ok", 0).show();
                Format_14 format_14 = Format_14.this;
                format_14.color = i;
                format_14.displayColor();
                if (Format_14.this.color_dialog.isShowing()) {
                    Format_14.this.color_dialog.dismiss();
                }
            }

            @Override // nithra.resume.maker.cv.builder.app.color.AmbilWarnaDialog.OnAmbilWarnaListener
            public void onCancel(AmbilWarnaDialog ambilWarnaDialog) {
                Toast.makeText(Format_14.this, "cancel", 0).show();
            }
        }).show();
    }
    ...
    public void onResume() {
        ...
        if (new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM).getPath() + "/Nithra/ResumeBuilder/" + this.sp.getString(this, "profile_name") + "_Basic Resume.pdf").exists()) {
