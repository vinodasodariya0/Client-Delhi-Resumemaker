...
public class Format_10 extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        ((AppCompatTextView) findViewById(R.id.title_name)).setText("Functional Resume");
        ...
        this.mWebView.setOnLongClickListener(new View.OnLongClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_10.AnonymousClass1 */
        ...
        this.save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (Format_10.this.sp.getInt(Format_10.this, "permissiond") == 1) {
                    ...
                    Format_10.this.createPdfFile();
                    Format_10.this.wait_dialog.show();
                    return;
                }
                Format_10.this.PermissionFun();
            }
        });
        this.picker.setOnClickListener(new View.OnClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_10.AnonymousClass3 */

            public void onClick(View view) {
                if (Format_10.this.sp.getInt(Format_10.this, "key") == 0) {
                    Format_10.this.sp.putString(Format_10.this, "type", "text");
                    Format_10.this.openDialog(false);
                } else if (Format_10.this.sp.getInt(Format_10.this, "key") == 1) {
                    Format_10.this.color_dialog.show();
                } else if (Format_10.this.sp.getInt(Format_10.this, "key") == 2) {
                    Format_10.this.color_dialog.show();
                } else if (Format_10.this.sp.getInt(Format_10.this, "key") == 3) {
                    Format_10.this.sp.putString(Format_10.this, "type", "text");
                    Format_10.this.openDialog(false);
                } else if (Format_10.this.sp.getInt(Format_10.this, "key") == 4) {
                    Format_10.this.sp.putString(Format_10.this, "type", "text");
                    Format_10.this.openDialog(false);
                } else if (Format_10.this.sp.getInt(Format_10.this, "key") == 5) {
                    Format_10.this.sp.putString(Format_10.this, "type", "text");
                    Format_10.this.openDialog(false);
                } else if (Format_10.this.sp.getInt(Format_10.this, "key") == 6) {
                    Format_10.this.sp.putString(Format_10.this, "type", "text");
                    Format_10.this.openDialog(false);
                } else if (Format_10.this.sp.getInt(Format_10.this, "key") == 7) {
                    Format_10.this.sp.putString(Format_10.this, "type", "text");
                    Format_10.this.openDialog(false);
                } else if (Format_10.this.sp.getInt(Format_10.this, "key") == 8) {
                    Format_10.this.sp.putString(Format_10.this, "type", "text");
                    Format_10.this.openDialog(false);
                }
            }
        ...
        ((LinearLayout) this.color_dialog.findViewById(R.id.text_lay)).setOnClickListener(new View.OnClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_10.AnonymousClass4 */
        ...
        ((LinearLayout) this.color_dialog.findViewById(R.id.border_lay)).setOnClickListener(new View.OnClickListener() {
            /* class nithra.resume.maker.cv.builder.app.Formates.Format_10.AnonymousClass5 */

            public void onClick(View view) {
                Format_10.this.sp.putString(Format_10.this, "type", "bg");
                Format_10.this.openDialog(false);
            }
        });
    ...
    private void first_load() {
        ...
        if (rawQuery.getCount() > 0) {
            ...
            if (string15.equals("") || string15.equals("null")) {
                this.image = "<div class='w3-quarter t3-profile1 w3-padding'>    </div>";
        ...
        if (rawQuery2.getCount() > 0) {
            ...
            if (rawQuery4.getCount() > 0) {
                ...
                this.info = "<div class='w3-padding-12 w3-row'>        <h6 class='t7-block_background w3-padding-tinysmall w3-margin-top-small w3-upper-case'><i class='fa fa-arrow-right fa-fw  w3-large w3-text-templete_color_1'></i>" + this.title + "</h6>        <div class='w3-container list'>" + this.pro_table + "        </div>    </div>";
            }
            rawQuery4.close();
            String str4 = "<table><tr>" + str + str2 + "</tr>" + str3 + "</table>";
            this.personal = "<div class='w3-threequarter t3-right w3-container'>       <h2 class='w3-upper-case t3-profile-name w3-margin-bottom-0'>" + this.name + "</h2>       <h6 class='t3-profile-address w3-margin-top-0'> " + str4.replaceAll("<br>", "") + "</h6>   </div>";
        }
        rawQuery2.close();
        if (this.sp.getBoolean(this, "sign_name_check").booleanValue()) {
            ...
            this.sign_btm_name = "<h6 style='text-align: right;width: 95%;'>(" + this.name + ")</h6>";
        } else {
            this.sign_name = "";
            this.sign_btm_name = "";
        }
        ...
        if (rawQuery6.getCount() > 0) {
            ...
            if (!string20.equals("")) {
                this.objective = "<div class='w3-padding-12 w3-row'>        <h6 class='t7-block_background w3-padding-tinysmall w3-margin-top-small w3-upper-case'><i class='fa fa-arrow-right fa-fw  w3-large w3-text-templete_color_1'></i> objective</h6>        <div class='w3-container list'>            <p>" + string20 + "</p>        </div>    </div>";
            }
            if (!string21.equals("")) {
                this.declar = "<div class='w3-no-break w3-row'>     <h6 class='t7-block_background w3-padding-tinysmall w3-upper-case'><i class='fa fa-arrow-right fa-fw  w3-large w3-text-templete_color_1'></i> Declaration</h6>     <div class='w3-container'>         <h6>" + string21 + "</h6>     </div> </div>";
            }
        }
            ...
            for (int i2 = 0; i2 < rawQuery7.getCount(); i2++) {
                ...
                if (rawQuery9.getCount() > 0) {
                    for (int i4 = 0; i4 < rawQuery9.getCount(); i4++) {
                        str6 = str6 + "<p class='w3-padding-left-20'><b>" + rawQuery9.getString(rawQuery9.getColumnIndex("title")) + " : </b>" + rawQuery9.getString(rawQuery9.getColumnIndex("value")) + "</p>";
                        rawQuery9.moveToNext();
                    }
                }
                rawQuery9.close();
                this.sub_exp += "<h6 class='w3-margin-bottom-0'><b>" + string25 + "</b></h6>           <p class='w3-padding-left-20 w3-margin-bottom-0 w3-margin-top-0'><b>Designation : </b>" + string24 + "</p>           <p class='w3-padding-left-20 w3-margin-bottom-0 w3-margin-top-0'>" + string22 + " - " + string23 + "</p>" + ((string26.equals("") || string26.equals(null)) ? "" : "<p class='w3-padding-left-20 w3-margin-bottom-0 w3-margin-top-0'><b>Role : </b>" + string26 + "</p>") + str6;
                rawQuery7.moveToNext();
            }
            this.experience = "                <div class='w3-no-break w3-row'>                    <h6 class='t7-block_background w3-padding-tinysmall w3-upper-case'><i class='fa fa-arrow-right fa-fw  w3-large w3-text-templete_color_1'></i> " + str5 + "</h6>                    <div class='w3-container list'>" + this.sub_exp + "            </div>                </div>";
        } else {
        ...
        if (rawQuery10.getCount() > 0) {
            ...
            for (int i5 = 0; i5 < rawQuery10.getCount(); i5++) {
                ...
                if (!string32.trim().equals("")) {
                    string32 = "<p class='w3-padding-left-20 w3-margin-bottom-0 w3-margin-top-0'><b>Company / Institute : </b>" + string32 + "</p>";
                }
                if (!string31.equals("")) {
                    str8 = string31.contains("member") ? "<p class='w3-padding-left-20 w3-margin-bottom-0 w3-margin-top-0'>" + ("<b>Team Size : </b>" + string31) + "</p>" : "<p class='w3-padding-left-20 w3-margin-bottom-0 w3-margin-top-0'>" + ("<b>Team Size : </b>" + string31 + " Members") + "</p>";
                }
                String str9 = "";
                ...
                if (rawQuery12.getCount() > 0) {
                    for (int i7 = 0; i7 < rawQuery12.getCount(); i7++) {
                        str9 = str9 + "<p class='w3-padding-left-20 w3-margin-bottom-0 w3-margin-top-0'><b>" + rawQuery12.getString(rawQuery12.getColumnIndex("title")) + " : </b>" + rawQuery12.getString(rawQuery12.getColumnIndex("value")) + "</p>";
                        rawQuery12.moveToNext();
                    }
                }
                rawQuery12.close();
                this.sub_work += "<h6 class='w3-margin-bottom-0'><b>" + string27 + "</b></h6>             <p class='w3-padding-left-20 w3-margin-bottom-0 w3-margin-top-0'><b>Description : </b>" + string28 + "</p>             <p class='w3-padding-left-20 w3-margin-bottom-0 w3-margin-top-0'><b>Duration : </b>" + string29 + "</p>             <p class='w3-padding-left-20 w3-margin-bottom-0 w3-margin-top-0'><b>Role : </b>" + string30 + "</p>" + string32 + str8 + str9;
                rawQuery10.moveToNext();
            }
            this.project = "<div class='w3-no-break w3-row'>    <h6 class='t7-block_background w3-padding-tinysmall w3-upper-case'><i class='fa fa-arrow-right fa-fw  w3-large w3-text-templete_color_1'></i> " + str7 + "</h6>    <div class='w3-container list'>" + this.sub_work + "    </div></div>";
        }
        rawQuery10.close();
            ...
            for (int i8 = 0; i8 < rawQuery13.getCount(); i8++) {
                ...
                if (rawQuery15.getCount() > 0) {
                    ...
                    for (int i10 = 0; i10 < rawQuery15.getCount(); i10++) {
                        str12 = str12 + "<p class='w3-padding-left-20 w3-margin-bottom-0 w3-margin-top-0'><b>" + rawQuery15.getString(rawQuery15.getColumnIndex("title")) + " : </b>" + rawQuery15.getString(rawQuery15.getColumnIndex("value")) + "</p>";
                        rawQuery15.moveToNext();
                    }
                    str11 = str12;
                }
                rawQuery15.close();
                this.sub_edu += "<h6 class='w3-margin-bottom-0'><b>" + string33 + ", " + string34 + "</b></h6>            <p class='w3-padding-left-20 w3-margin-bottom-0 w3-margin-top-0'><b>" + string35 + "</b></p>            <p class='w3-padding-left-20 w3-margin-bottom-0 w3-margin-top-0'>" + string36 + "</p>" + str11;
                rawQuery13.moveToNext();
            }
            this.education = "<div class='w3-no-break w3-row'>        <h6 class='t7-block_background w3-padding-tinysmall w3-upper-case'><i class='fa fa-arrow-right fa-fw  w3-large w3-text-templete_color_1'></i> " + str10 + "</h6>        <div class='w3-container list'>" + this.sub_edu + "        </div>    </div>";
        }
        rawQuery13.close();
        ...
        if (rawQuery16.getCount() > 0) {
            ...
            this.skill = "<div class='w3-no-break w3-row'>    <h6 class='t7-block_background w3-padding-tinysmall w3-upper-case'><i class='fa fa-arrow-right fa-fw  w3-large w3-text-templete_color_1'></i> " + str13 + "</h6>    <div class='w3-container list'>" + this.sub_skill + "    </div></div>";
        }
        rawQuery16.close();
        ...
        if (rawQuery18.getCount() > 0) {
            ...
            this.strength = "<div class='w3-no-break w3-row'>       <h6 class='t7-block_background w3-padding-tinysmall w3-upper-case'><i class='fa fa-arrow-right fa-fw  w3-large w3-text-templete_color_1'></i> " + str14 + "</h6>       <div class='w3-container list'>" + this.sub_strength + "       </div>   </div>";
        }
        rawQuery18.close();
        ...
        if (rawQuery20.getCount() > 0) {
            ...
            this.intrest = "<div class='w3-no-break w3-row'>    <h6 class='t7-block_background w3-padding-tinysmall w3-upper-case'><i class='fa fa-arrow-right fa-fw  w3-large w3-text-templete_color_1'></i> " + str15 + "</h6>    <div class='w3-container list'>" + this.sub_intrest + "      </div>  </div>";
        }
        rawQuery20.close();
        ...
        if (rawQuery22.getCount() > 0 || rawQuery24.getCount() > 0) {
            this.explore = "<div class='w3-no-break w3-row'>      <h6 class='t7-block_background w3-padding-tinysmall w3-upper-case'><i class='fa fa-arrow-right fa-fw  w3-large w3-text-templete_color_1'></i> Industrial Exposure</h6>      <div class='w3-container list'>" + this.indrust + this.inplant + "      </div>  </div>";
        }
        rawQuery22.close();
        rawQuery24.close();
        ...
        if (rawQuery26.getCount() > 0) {
            ...
            this.achive = "<div class='w3-no-break w3-row'>    <h6 class='t7-block_background w3-padding-tinysmall w3-upper-case'><i class='fa fa-arrow-right fa-fw  w3-large w3-text-templete_color_1'></i> " + str18 + "</h6>    <div class='w3-container list'>                      " + this.sub_achive + "    </div></div>";
        }
        rawQuery26.close();
        ...
        if (rawQuery30.getCount() > 0 || rawQuery28.getCount() > 0) {
            this.curricular = "<div class='w3-no-break w3-row'>         <h6 class='t7-block_background w3-padding-tinysmall w3-upper-case'><i class='fa fa-arrow-right fa-fw  w3-large w3-text-templete_color_1'></i> Curricular Activities</h6>         <div class='w3-container list'>" + this.cocuri + this.extra + "         </div>     </div>";
        }
        rawQuery30.close();
        rawQuery28.close();
        ...
        if (rawQuery32.getCount() > 0) {
            ...
            this.hobbi = "<div class='w3-no-break w3-row'>    <h6 class='t7-block_background w3-padding-tinysmall w3-upper-case'><i class='fa fa-arrow-right fa-fw  w3-large w3-text-templete_color_1'></i> " + str21 + "</h6>    <div class='w3-container list'>" + this.sub_hobbi + "    </div></div>";
        }
        rawQuery32.close();
        ...
        if (rawQuery34.getCount() > 0) {
            ...
            this.reference = "<div class='w3-no-break w3-row'>        <h6 class='t7-block_background w3-padding-tinysmall w3-upper-case'><i class='fa fa-arrow-right fa-fw  w3-large w3-text-templete_color_1'></i> " + str22 + "</h6>        <div class='w3-container list'>" + this.sub_refer + "        </div>    </div>";
        }
        rawQuery34.close();
    }
        ...
        try {
            ...
            new PdfWriter(getApplicationContext(), this.mWebView.createPrintDocumentAdapter(), createEmptyFile).write(new PdfWriter.PdfWriterCallback() {
                ...
                public void onWriteFinished() {
                    ...
                    try {
                        Format_10.this.startActivity(intent);
                    } catch (ActivityNotFoundException unused) {
                        Utils.toast_center(Format_10.this, "No Application available to view PDF");
                    }
                }
    ...
    public void PermissionFun() {
        if (Build.VERSION.SDK_INT < 23) {
            ...
            textView.setOnClickListener(new View.OnClickListener() {
                /* class nithra.resume.maker.cv.builder.app.Formates.Format_10.AnonymousClass7 */

                @SuppressLint({"NewApi"})
                public void onClick(View view) {
                    if (Format_10.this.sp.getInt(Format_10.this, "permissiond") == 2) {
                        Intent intent = new Intent();
                        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        intent.setAction("android.settings.APPLICATION_DETAILS_SETTINGS");
                        intent.setData(Uri.fromParts("package", Format_10.this.getPackageName(), null));
                        Format_10.this.startActivity(intent);
                        dialog.dismiss();
                        return;
                    }
                    Format_10.this.requestPermissions(new String[]{"android.permission.WRITE_EXTERNAL_STORAGE"}, 151);
                    dialog.dismiss();
                }
            });
            dialog.show();
    ...
    public void openDialog(boolean z) {
        new AmbilWarnaDialog(this, this.color, z, new AmbilWarnaDialog.OnAmbilWarnaListener() {
            ...
            public void onOk(AmbilWarnaDialog ambilWarnaDialog, int i) {
                ...
                format_10.color = i;
                format_10.displayColor();
                if (Format_10.this.color_dialog.isShowing()) {
                    Format_10.this.color_dialog.dismiss();
                }
            }
    ...
    public void onResume() {
        ...
        if (new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM).getPath() + "/Nithra/ResumeBuilder/" + this.sp.getString(this, "profile_name") + "_Functional Resume.pdf").exists()) {
